...
?></h1><div class="wssC10"><div class="wssC9"><ul class="wssO7"><li class="wssO8 wssO9 wssO0"><a href="javascript:yass.a({href:'#wss_wizard'});void(0)" class="wssJ"><span class="wssJ30">1</span> <?php
	echo _WEBO_WIZARD_STEP1;
?></a><span class="wssJ32"></span></li><li class="wssO8"><a href="javascript:yass.wz=47;yass.wizard()" class="wssJ"><span class="wssJ30">2</span> <?php
	echo _WEBO_WIZARD_STEP2;
?></a><span class="wssJ32"></span></li><li class="wssO8"><a href="javascript:yass.wz=50;yass.wizard()" class="wssJ"><span class="wssJ30">3</span> <?php
...
?><span class="wssJ31"></span></div><div class="wssC11 wssC12 wssA0 wssC22"><h3 class="wssB3"><?php
	echo _WEBO_WIZARD_STEP12;
?></h3><?php
	echo _WEBO_WIZARD_STEP12_INFO;
?><span class="wssJ31"></span></div><div class="wssC11 wssC12 wssA0 wssC23"><h3 class="wssB3"><?php
	echo _WEBO_WIZARD_STEP13;
?></h3><?php
	echo _WEBO_WIZARD_STEP13_INFO;
?><span class="wssJ31"></span></div><div class="wssC11 wssC12 wssA0 wssC24"><h3 class="wssB3"><?php
	echo _WEBO_WIZARD_STEP14;
?></h3><?php
	echo _WEBO_WIZARD_STEP14_INFO;
?><span class="wssJ31"></span></div><div class="wssC11 wssC12 wssA0 wssC25"><h3 class="wssB3"><?php
	echo _WEBO_WIZARD_STEP15;
?></h3><?php
	echo _WEBO_WIZARD_STEP15_INFO;
?><span class="wssJ31"></span></div><div class="wssC11 wssC12 wssA0 wssC26"><h3 class="wssB3"><?php
	echo _WEBO_WIZARD_STEP16;
?></h3><?php
	echo _WEBO_WIZARD_STEP16_INFO;
?><span class="wssJ31"></span></div><div class="wssC11 wssC12 wssA0 wssC27"><h3 class="wssB3"><?php
	echo _WEBO_WIZARD_STEP17;
?></h3><?php
	echo _WEBO_WIZARD_STEP17_INFO;
?><span class="wssJ31"></span></div><div class="wssC11 wssC12 wssA0 wssC28"><h3 class="wssB3"><?php
	echo _WEBO_WIZARD_STEP18;
?></h3><?php
	echo _WEBO_WIZARD_STEP18_INFO;
?><span class="wssJ31"></span></div><form class="wssC11 wssC13 wssA0 wssC6"><h3 class="wssB3"><?php
...
?>" value="2"/></dd></dl><a href="javascript:yass.wz=yass.doc.getElementById('wss_manual1').checked?50:48;yass.wizard()" class="wssJ5"><?php
...
?>" value="2"/></dd></dl><a href="javascript:yass.wiz('49&web_optimizer_wizard_options='+(yass.doc.getElementById('wss_serverside2').checked?2:1))" class="wssJ5"><?php
	echo _WEBO_WIZARD_NEXT;
...
?></li><li class="wssO8 wssA0"><?php
	echo _WEBO_WIZARD_STEP18;
?></li></ul><a href="javascript:yass.wz=50;yass.wizard()" class="wssJ5"><?php
	echo _WEBO_WIZARD_NEXT;
...
?></p><a href="javascript:yass.wiz(51)" class="wssJ7"><?php
