...
?></noscript><ul class="wssM"><li class="wssM1">
		<a class="wssM2" href="#wss_dashboard" title="<?php
...
<div class="wssN">
	<div class="wssN4">
		<div class="wssN5 wssN11">
			<div class="wssN2">
				<h2 class="wssB"><a href="mailto:speed@webo.name?subject=WEBO Site SpeedUp Installation" class="wssN3"><?php
	...
	echo _WEBO_DASHBOARD_HELP2;
				?></p>
				<p class="wssI">
					<a href="mailto:speed@webo.name?subject=WEBO Site SpeedUp Installation" class="wssJ5">
					<?php
	...
	echo _WEBO_DASHBOARD_BUZZ;
				?></a></h2>
				<p class="wssI"><a href="http://extensions.joomla.org/extensions/site-management/cache/10152" rel="nofollow" class="wssJ wssJ13">Joomla! Extensions Directory</a></p>
				<p class="wssI"><a href="http://wordpress.org/extend/plugins/web-optimizer/" rel="nofollow" class="wssJ wssJ14">WordPress</a></p>
				<p class="wssI"><a href="http://twitter.com/wboptimizer" rel="nofollow" class="wssJ wssJ10">Twitter</a></p>
				<p class="wssI"><a href="http://www.facebook.com/pages/Web-Optimizer/183974322020" rel="nofollow" class="wssJ wssJ11">Facebook</a></p>
				<p class="wssI"><a href="http://blog.web-optimizer.us/" rel="nofollow" class="wssJ wssJ12">Blogger</a></p>
	...
	echo _WEBO_DASHBOARD_LOADING;
				...
				<a class="wssJ20" href="javascript:_.hide('wss_news')"></a>
			</div>
		</div>
	</div>
	<div class="wssN4">
	...
	if ($premium < 2) {
		...
		echo _WEBO_DASHBOARD_LOADING;
				...
				?><a class="wssJ20" href="javascript:_.hide('wss_sp')"></a>
			</div>
		</div>
		<div class="wssN5<?php
	echo $premium<2 ? ' wssN20' : '';
	...
	echo _WEBO_DASHBOARD_LINKS;
				?></a></h2>
				<ul class="wssO wssO3">
					<li class="wssO4"><a href="http://www.web-optimizer.us/?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer" class="wssJ wssJ2"><?php
	echo _WEBO_DASHBOARD_LINKS_WEBSITE;
					?></a></li>
					<li class="wssO4"><a href="http://code.google.com/p/web-optimizator/w/list?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer" class="wssJ wssJ2"><?php
	echo _WEBO_DASHBOARD_LINKS_UG;
					?></a></li>
					<li class="wssO4"><a href="http://code.google.com/p/web-optimizator/issues/list?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer" class="wssJ wssJ2"><?php
	echo _WEBO_DASHBOARD_LINKS_ISSUES;
					?></a></li>
					<li class="wssO4"><a href="http://web-optimizer.us/support/?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer" class="wssJ wssJ2"><?php
	echo _WEBO_DASHBOARD_LINKS_SUPPORT;
					?></a></li>
				</ul>
				<a class="wssJ20" href="javascript:_.hide('wss_links')"></a>
			</div>
		</div>
	</div>
	...
	if ($active) {
		...
		echo _WEBO_DASHBOARD_STATUS_TESTING;
			?></p><ul class="wssO wssO3"><li class="wssO4"><a href="http://<?php
		echo $website;
			?>/?web_optimizer_debug=1" class="wssJ"><?php
		echo _WEBO_DASHBOARD_STATUS_TESTING2;
			?></a>,</li><li class="wssO4"><a href="javascript:_.doc.cookie='web_optimizer_debug=1;expires='+(new Date(new Date().getTime()+86400)).toGMTString()+';path=/;domain='+_.doc.domain+';';_.doc.location.href='http://'+_.doc.domain+'/'"><?php
