...
?></span></a></li></ul><h1 class="wssA wssA6"><?php
...
?></p><form action="#wss_minify" class="wssC wssC4" method="post" enctype="multipart/form-data"><?php
	if ($submit) {
?><p class="wssI"><a href="#wss_minify" class="wssJ7" onclick="yass.g(3)"><?php
		echo _WEBO_GZIP_COMPRESS;
?><span class="wssJ6"></span></a></p><?php
	}
?><p class="wssI"><a href="#wss_minify" class="wssJ5" onclick="yass('.wssI3')[0].style.display='block';var a=yass('.wssC4')[0];if(yass.b.ie){yass[a.name]({target:a})}else{a.onsubmit({target:a})}"><?php
