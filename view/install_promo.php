...
?></th><th class="wssT7"><?php
	echo _WEBO_SPLASH2_COMPARISON_FASTWEBSITE;
?><span class="wssI"><?php
	echo _WEBO_SPLASH2_COMPARISON_FULLPRICE;
?></span><a href="<?php
	echo _WEBO_DASHBOARD_ORDER;
?>" class="wssJ"><?php
	echo _WEBO_SPLASH2_COMPARISON_ORDER;
?></a></th></tr></thead><tfoot><tr><th class="wssT7"> </th><th class="wssT7"> </th><td class="wssT7"><?php
	echo _WEBO_GENERAL_BUYNOWLITE;
?></td><td class="wssT7"><a href="<?php
	echo _WEBO_DASHBOARD_ORDER;
?>" class="wssJ"><?php
	echo _WEBO_SPLASH2_COMPARISON_ORDER;
?></a></td></tr></tfoot><tbody><tr class="wssT8 wssT12"><th class="wssT9 wssT11"><?php
