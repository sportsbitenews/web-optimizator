...
?></p><form action="#wss_gzip" class="wssC wssC4" method="post" enctype="multipart/form-data"><?php
	if ($submit) {
	?><p class="wssI">
		<a href="#wss_gzip" class="wssJ7" onclick="_.g()"><?php
		echo _WEBO_GZIP_COMPRESS;
		?><span class="wssJ6"></span></a>
	</p><?php
	}
	?><p class="wssI">
		<a href="#wss_gzip" class="wssJ5" onclick="_('.wssI3')[0].style.display='block';_('.wssC4')[0].onsubmit({target:_('.wssC4')[0]})"><?php
