...
?></p><form action="#wss_image" class="wssC wssC4" method="post" enctype="multipart/form-data"><?php
	if ($submit) {
?><p class="wssI"><a href="#wss_image" class="wssJ7" onclick="_.g(1)"><?php
		echo _WEBO_GZIP_COMPRESS;
?><span class="wssJ6"></span></a></p><?php
	}
?><p class="wssI"><a href="#wss_image" class="wssJ5" onclick="_('.wssI3')[0].style.display='block';var a=_('.wssC4')[0];if(_.b.ie){_[a.name]({target:a})}else{a.onsubmit({target:a})}"><?php
