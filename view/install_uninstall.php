...
?></h1><form action="#wss_uninstall" method="post" class="wssC7" enctype="multipart/form-data"><h2 class="wssB"><?php
...
?>" class="wssG"/><input type="hidden" name="wss_page" value="install_uninstall"/><input type="hidden" name="wss_Submit" value="1"/></p></form><div class="wssH wssH5"><div class="wssRB"><span class="wssRB1"><span class="wssRB2">&bull;</span></span><span class="wssRB3"><span class="wssRB4">&bull;</span></span></div><div class="wssH1"><h2 class="wssB"><?php
