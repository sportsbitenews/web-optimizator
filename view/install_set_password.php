...
?>:</label></dt><dd class="wssD2"><input id="wss_username" name="wss_username" title="<?php
	echo _WEBO_LOGIN_ENTERLOGIN;
?>" class="wssF" value="<?php
	if (empty($submit) || !empty($username)) {
		echo htmlspecialchars($username);
}?>"/></dd><dt class="wssD1"><label for="wss_password" class="wssE"><?php 
...
?>"/></dd><dt class="wssD1"><label for="wss_confirm" class="wssE"><?php 
...
?>"/></dd><dt class="wssD1"><label for="wss_license" class="wssE"><?php 
...
?>"/><span class="wssD4"><?php
	echo _WEBO_LOGIN_EMAILNOTICE;
?></span></dd><dt class="wssD5"><label for="wss_confirmagreement" class="wssE"><?php 
...
?>:</label></dt><dd class="wssD6 wssD7<?php
	if (!empty($error[4])) {
?> wssD8<?php
	}
?>"><span class="wssD3">*</span><input type="checkbox" id="wss_confirmagreement" name="wss_confirmagreement" title="<?php
...
?>" class="wssG"/><input type="hidden" name="wss_page" value="install_set_password"/><input type="hidden" name="wss_Submit" value="1"/></p></form><div class="wssH wssH2"><div class="wssRB"><span class="wssRB1"><span class="wssRB2">&bull;</span></span><span class="wssRB3"><span class="wssRB4">&bull;</span></span></div><div class="wssH1"><h2 class="wssB"><?php
	echo _WEBO_NEW_TITLE;
?></h2><?php
	echo _WEBO_NEW_PROTECT;
?></div><div class="wssRB"><span class="wssRB5"><span class="wssRB6">&bull;</span></span><span class="wssRB7"><span class="wssRB8">&bull;</span></span></div></div>