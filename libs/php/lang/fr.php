...
define('_WEBO_GENERAL_BUYNOWZERO', '<a href="https://www.softkey.net/catalog/basket.php?id=582711&amp;act=buy&amp;from=1722979" class="wssJ" title="WEBO Site SpeedUp Zero Edition">Acheter</a>');
...
define('_WEBO_unobtrusive_background', 'Charger les background images en <code>DOMready</code> event');
define('_WEBO_unobtrusive_background_HELP', 'Le chargement des images de fond sera différé à l\'évènement DOMReady . Cela augmentera la vitesse du rendement initial de la page dans les serveurs .');
define('_WEBO_unobtrusive_background_EFFECT', 'Website rendering speedup by 20-50%');
define('_WEBO_unobtrusive_background_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformiser les fichiers cache pour tous les serveurs&quot; enabled.');
...
define('_WEBO_data_uris_mhtml_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformiser les fichiers cache pour tous les serveurs&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_separate_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformiser les fichiers cache pour tous les serveurs&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_size_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformiser les fichiers cache pour tous les serveurs&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_mhtml_size_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformiser les fichiers cache pour tous les serveurs&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_ignore_list_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformiser les fichiers cache pour tous les serveurs&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_additional_list_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformiser les fichiers cache pour tous les serveurs&quot; enabled or CSS files are not combined.');
...
define('_WEBO_htaccess_mod_deflate_HELP', 'Ceci est requis pour une compression dynamique de gzip. C\'est une alternative pour gzip.');
...
define('_WEBO_htaccess_mod_gzip_HELP', 'Ceci est requis pour une compression dynamique de gzip. C\'est une alternative pour deflate.');
...
define('_WEBO_htaccess_local_HELP',  'Le fichier .htaccess / web.config sera placé dans le fichier serveur local mais non dans le document racine de l\'hébergeur web.');
...
define('_WEBO_iis_enabled', 'Permettre <code>web.config</code>');
define('_WEBO_iis_local', 'Placer le fichier <code>web.config</code> localement (pas à la racine du document.)');
define('_WEBO_iis_mod_deflate', 'Utiliser <code>DEFLATE</code>');
define('_WEBO_iis_mod_gzip', 'Utiliser <code>httpCompression</code>');
define('_WEBO_iis_mod_expires', 'Utiliser <code>clientCache</code>');
define('_WEBO_iis_mod_headers', 'Utiliser <code>HEADERS</code>');
define('_WEBO_iis_mod_setenvif', 'Utiliser <code>SETENVIF</code>');
define('_WEBO_iis_mod_mime', 'Utiliser <code>MIME</code>');
define('_WEBO_iis_mod_rewrite', 'Utiliser <code>rewrite</code>');
...
define('_WEBO_DASHBOARD_AVAILABLE', 'Disponible dans L\'Edition Standard');
