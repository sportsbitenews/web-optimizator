...
define('_WEBO_unobtrusive_ads_HELP', 'Код всех рекламных блоков (контекстной и баннерной рекламы) будет переноситься к закрывающему тэгу &lt;/body&gt;.');
...
define('_WEBO_SYSTEM_javascript_writable_HELP', 'Пожалуйста, проверьте права для директории JavaScript-кэша, которая указана на странице "Состояние системы" (вкладка "Параметры"). Необходимо либо изменить эту диреторию на доступную, либо выполнить для нее CHMOD 775 или CHMOD 777.');
define('_WEBO_SYSTEM_css_writable', 'CSS-директория не доступна');
define('_WEBO_SYSTEM_css_writable_HELP', 'Пожалуйста, проверьте права для директории CSS-кэша, которая указана на странице "Состояние системы" (вкладка "Параметры"). Необходимо либо изменить эту диреторию на доступную, либо выполнить для нее CHMOD 775 или CHMOD 777.');
...
define('_WEBO_SYSTEM_gzip_possibility_HELP', 'На сервере не установлено PHP-расширение zlib. Оно используется для сжатия текстовых файлов "на лету", что эконоит около 80% передаваемых данных. Для установки этого расширения, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно достаточно переустановить PHP, включив это расширение. [http://ru.php.net/manual/en/book.zlib.php Информация о zlib на php.net] и [http://ru.php.net/manual/en/install.windows.extensions.php информация о расширении zlib для Windows-окружений].');
...
define('_WEBO_SYSTEM_gd_full_support_HELP', 'На сервере установлено PHP-расширения gd, но доступен не весь функционал. Это может привести к некорректному созданиюю CSS Sprites. Для установки этого расширения со всеми функциями, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно достаточно переустановить PHP, включив это расширение. [http://ru.php.net/manual/en/book.image.php Информация о gd на php.net] и [http://php.net/manual/en/install.windows.extensions.php информация о расширении zlib для Windows-окружений].');
define('_WEBO_SYSTEM_yui_possibility', 'YUI Compressor не доступен');
define('_WEBO_SYSTEM_yui_possibility_HELP', 'Функция shell_exec не разрешена для вашего сайта, либо не доступна java. YUI Compressor выполняется как бинарное java-приложение и лучше (по сравнению с JSMin) уменьшает JavaScript-файлы в размере. Чтобы разрещить функцию shell_exec или установить java, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно достаточно разрешить shell_exec в PHP-конфигурации или установить java на веб-сервер. [http://ru.php.net/manual/en/function.shell-exec.php Информация о shell_exec на php.net] и [http://www.java.com/en/download/help/5000010500.xml информация об установке java для Linux-окружений].');
...
define('_WEBO_SYSTEM_mod_headers_HELP', 'На сайте нет поддержки mod_headers, который используется для улучшения сжатия для различныз браузеров (исключения тех, которые его не поддерживают) и для отключения использования ETag. Для подключения этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://www.websiteoptimization.com/speed/tweak/cache/ Руководство по подключению mod_headers] и [http://httpd.apache.org/docs/2.0/mod/mod_headers.html подробнее о mod_headers]');
...
define('_WEBO_SYSTEM_mod_setenvif_HELP', 'На сайте нет поддержки mod_setenvif, который используется для улучшения сжатия для различныз браузеров (исключения тех, которые его не поддерживают). Для подключения этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://www.debuntu.org/2006/06/15/66-how-to-enable-apache-modules-under-debian-based-system Руководство по подключению mod_mime для Ubuntu] и [http://httpd.apache.org/docs/1.3/mod/mod_setenvif.html подробнее о mod_setenvif]');
...
define('_WEBO_SYSTEM_cms_HELP', 'WEBO Site SpeedUp не поддерживает данную CMS. Вам необходимо вручную добавить требуемые вызовы в исходные файлы системы. Более подробная информация приведена на странице "Состояние системы" (вкладка "Установка/Удвление").');
