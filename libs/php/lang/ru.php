...
/* Uninstall */
define('_WEBO_LOGIN_UNINSTALL', 'Чтобы удалить WEBO Site SpeedUp, пожалуйста, введите ваш логин и пароль и нажмите кнопку <strong>Удалить</strong>.');
define('_WEBO_LOGIN_UNINSTALL2', 'WEBO Site SpeedUp может быть отключен для вашего сайта. Для этого его нужно просто удалить.');
define('_WEBO_LOGIN_UNINSTALLME', 'Удалить WEBO Site SpeedUp');
...
define('_WEBO_SPLASH1_CLEAR_CACHE', 'Чтобы очистить кэш WEBO Site SpeedUp, пожалуйста, введите ваш логин и пароль и нажмите кнопку <strong>Очистить кэш</strong>. ');
...
define('_WEBO_NEW_PROTECT', '<p class="wssI">Для обеспечения безопасности при дальнейшем использовании WEBO Site SpeedUp необходимо установить пароль доступа. <strong>Демонстрационная версия</strong> устанавливается без лицензионного ключа.</p><p class="wssI">Перед проведением установки, пожалуйста, убедитесь, что корневой <code>.htaccess</code> и файлы используемой веб-системы доступны на запись (при проведении установки WEBO Site SpeedUp также создает резерные копии).</p><p class="wssI">WEBO Site SpeedUp может самостоятельно проверить доступные возможности вашего сервера и провести установку в автоматическом режиме. Для этого нужно выбрать <strong>&laquo;Быстрая установка&raquo;</strong>. В дальнейшем вы сможете изменить все сохраненные настройки, используя текущий интерфейс.</p><p class="wssI">Если вы хотите настроить использование WEBO Site SpeedUp самостоятельно, то нужно выбрать <strong>&laquo;Далее&raquo;</strong>. Вы сможете проверить все настройки до их применения для вашего сайта.</p><p class="wssI"><a href="http://webo.in/articles/habrahabr/99-web-optimizer-installation-0.5/" class="wssJ">Процесс установки WEBO Site SpeedUp</a></p>');
define('_WEBO_NEW_USERDATA', 'Ваш логин и пароль');
define('_WEBO_NEW_ENTER', 'Установите ваш логин и пароль');
define('_WEBO_NEW_ORDERINSTALLATION', 'Заказать установку и настройку WEBO Site SpeedUp для вашего сайта');
...
define('_WEBO_PASSWORD_INSTALLED', 'Для данного сайта уже установлен WEBO Site SpeedUp. Вы можете сменить пароль доступа к его функциям администрирования: Изменения настроек, Удаление файлов из кэша, Обновления, Отключения и Удаления.');
...
define('_WEBO_minify_javascript2', 'Объединять только JavaScript, подключенный в тэге &lt;head&gt;');
define('_WEBO_minify_javascript3', 'Объединять JavaScript, подключенный в тэгах &lt;head&gt; и &lt;body&gt;');
...
define('_WEBO_performance_uniform_cache_HELP', 'Ввсе браузеры будут получать одинаковый CSS-, JavaScript- и HTML-код, благодаря чему будет возможно безопасное использование внешних кэширующих механизмов, однако при этом станет невозможным использование ряда технологий оптимизации, таких как data:URI.');

define('_WEBO_data_uris_on', 'Использовать <code>data:URI</code>');
define('_WEBO_data_uris_on_HELP', 'Если эта опция включена, фоновые изображения будут преобразовываться в формат base64 и подставляться в CSS-файлы для всех браузеров, поддерживающих технологию data:URI.');
define('_WEBO_data_uris_mhtml', 'Использовать <code>mhtml</code>');
define('_WEBO_data_uris_mhtml_HELP', 'Если эта опция включена, фоновые изображения будут преобразовываться в формат mhtml и подставляться в CSS-файлы для всех версий Internet Explorer, не поддерживающих технологию data:URI.');
...
define('_WEBO_data_uris_ignore_list_HELP', 'Изображения, указанные в этом поле, не будут преобразованы в формат base64.');
define('_WEBO_data_uris_additional_list', 'Исключить из <code>mhtml</code> файлы');
define('_WEBO_data_uris_additional_list_HELP', 'Изображения, указанные в этом поле, не будут преобразованы в формат mhtml.');
define('_WEBO_data_uris_separate', 'Отделить картинки от CSS-кода');
define('_WEBO_data_uris_separate_HELP', 'Если эта опция включена, преобразованный код CSS и изображения в форматах base64 и mhtml будут храниться в отдельных файлах.');
define('_WEBO_data_uris_domloaded', 'Загружать изображения по событию <code>DOMready</code>');
define('_WEBO_data_uris_domloaded_HELP', 'Если эта опция включена, загрузка фоновых изображений будет откладываться до события DOMReady.');
...
define('_WEBO_css_sprites_ignore_list_HELP', 'Изображения, указанные в этом поле, не будут преобразованы по технологии CSS Sprites.');
...
define('_WEBO_htaccess_local_HELP', 'Расположить <code>.htaccess</code> в локальной (не корневой) директории');
...
define('_WEBO_htaccess_mod_rewrite_HELP', 'Требуется для статического сжатия файлов.');

define('_WEBO_parallel_enabled', 'Распределять файлы по нескольким хостам');
define('_WEBO_parallel_enabled_HELP', 'Если эта опция включена, все файлы изображений, вызываемые на веб-страницах будут автоматически распределяться по нескольким хостам. Так, например, вызовы файлов http://site.ru/i/logo.png и /i/bg.jpg могут быть заменены вызовами http://i1.site.ru/i/logo.png и http://i2.site.ru/i/bg.jpg, при условии, что хосты i1 и i2 доступны и указаны в поле &laquo;Использовать хосты&raquo;.');
define('_WEBO_parallel_check', 'Автоматически определять доступные хосты');
define('_WEBO_parallel_check_HELP', 'Если эта опция включена, доступные хосты будут определяться автоматически.');
...
define('_WEBO_footer_text_HELP', 'Ссылка на WEBO Site SpeedUp ялвяется обязательным требованием для некомерческой версии и может быть убрана только в платной версии.');
define('_WEBO_footer_image', 'Изображение обратной ссылки');
define('_WEBO_footer_image_HELP', 'Имя файла с логотипом WEBO Site SpeedUp. Достпуные файлы находятся в следующей директории: <путь к WEBO Site SpeedUp>/web-optimizer/images/. Если это поле оставлено пустым, вместо изображения будет отображаться текст, укащанный в поле &laquo;Текст обратной ссылки&raquo;.');
...
define('_WEBO_DASHBOARD_STATUS_WORKING', 'Вы можете перевести приложение в режим отладки. Для этого надо его отключить.');
...
define('_WEBO_DASHBOARD_STATUS_TESTING3', 'После этого его можно включить.');
...
define('_WEBO_SPLASH3_NOTLIVE', 'На самом деле у вас довольно большой простор действий. Вы можете провести любые изменения в конфигурации WEBO Site SpeedUp (но лучше это проводить на тестовом сайте) для достижения оптимальной производительности. Для изменения настроек нужно:');
...
define('_WEBO_SPLASH3_HTACCESS_CHMOD5', 'Пожалуйста, убедитесь, что WEBO Site SpeedUp установлен в');
...
define('_WEBO_SPLASH3_ADDITIONAL_INFO', 'Вы можете провести дополнительные изменения на вашем сайте, которые позволят использовать WEBO Site SpeedUp более эффективно. К числу таких изменений можно отнести:');
define('_WEBO_SPLASH3_ADDITIONAL_INFO_1', '<strong>Сделайте ваш сайт соответствующим спецификациям (HTML, JavaScript и CSS).</strong> Нестандартные вызовы файлов и некорректный код приводит к различному рода ошибкам и ограничение функциональности WEBO Site SpeedUp.');
define('_WEBO_SPLASH3_ADDITIONAL_INFO_2', '<strong>Вынесите все JavaScript- и CSS-файлы, требуемые для загрузки сайта, в <code>head</code>-секцию страницы.</strong> Это позволит WEBO Site SpeedUp управлять их объединением и сжатием.');
define('_WEBO_SPLASH3_ADDITIONAL_INFO_3', '<strong>Подключите множественные хосты для вашего сайта.</strong> Для этого в DNS необходимо указать <code>* IN A IP_адрес_вашего_сервера</code>, подключить соответствующие поддомены (например, <code>i1</code> <code>i2</code> <code>i3</code> <code>i4</code>) и провести установку заново. WEBO Site SpeedUp самостоятельно обнаружит доступные хосты и распределит изображения по ним.');
define('_WEBO_SPLASH3_ADDITIONAL_INFO_4', '<strong>Вынесите все стили и скрипты, прописанные прямо в коде страницы, во внешние файлы.</strong> Во-первых, это позволит вам проще управлять изменениями на вашем сайте. Во-вторых, это позволит WEBO Site SpeedUp объединить, минимизировать и закэшировать весь объем дополнительного кода, который требуется для правильного функционирования вашего сайта.');
