...
define('_WEBO_performance_restore_selectors', 'Восстанавливать CSS-свойства');
define('_WEBO_performance_restore_selectors_HELP', 'Пропущенные CSS-свойства могут быть восстановлены при создании CSS Sprites или data:URI, чтобы уменьшить результирующий размер файлов в кэше. Однако это может привести к существенным процессорным издержкам в случае большого количества CSS-правил.');
