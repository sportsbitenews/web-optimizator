...
define('_WEBO_SPLASH2_EXPIRES_INFO', 'В результате работы этой настройки ко всем статическим файлов будут добавлены заголовки кэширования, позволяющие предоствратить их повторный запрос с сервера для одного и того же пользователя.
...
define('_WEBO_SPLASH2_FOOTER_INFO', 'Веб Оптимизавтор может добавить значок оптимизатора со ссылкой на сайт проекта. Это может быть как печать, так и ссылка, а также и то, и другое.
...
define('_WEBO_SPLASH3_CANTWRITE3', 'Вы можете сделать это и из своего FTP-клиента. Для этого нужно перейти в директорию, зайти в ее свойства или выполнить CHMOD 775.');
...
define('_WEBO_SPLASH3_HTACCESS_CHMOD2', 'Для этого выполните CHMOD 775, или создайте в корне файл <code>.htaccess</code>, доступный для чтения и записи для вашего веб-сервера, или разрешите чтение и запись для текущего файла <code>.htaccess</code> (CHMOD 664).');
