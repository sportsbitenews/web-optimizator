...
define('_WEBO_WIZARD_STEP21_INFO', 'Теперь вы можете завершить настройку или узнать о возможностях WEBO Site SpeedUp, которые могут быть настроены вручную. К ручной настройке всегда можно будет вернуться на странице &laquo;Настройка&raquo;.');
define('_WEBO_WIZARD_STEP211', 'Завершить настройку');
define('_WEBO_WIZARD_STEP211_HELP', 'По завершению настройки вы сможете сохранить полученную конфигурацию WEBO Site SpeedUp.');
define('_WEBO_WIZARD_STEP212', 'Продолжить ручную настройку');
define('_WEBO_WIZARD_STEP212_HELP', 'В процессе ручной настройки конфигурация WEBO Site SpeedUp будет сохранена, также вы узнаете о методах ускорения, требующих отдельной ручной настройки.');
...
define('_WEBO_WIZARD_STEP31_INFO2', 'Для получение большего ускорение произведите ручную настройку на странице');
