...
define('_WEBO_far_future_expires_video', 'Кэшировать видео-файлы (только через <code>.htaccess</code>)');
define('_WEBO_far_future_expires_static', 'Кэшировать другие файлы (только через <code>.htaccess</code>)');
