...
define('_WEBO_sql_cache_enabled_DISABLED', 'Для корректной работы кэширования SQL-запросов необходима установка WEBO Site SpeedUp на уровне системного расширения (а не в качестве отдельного приложения).');
...
define('_WEBO_sql_cache_time_DISABLED', 'Для корректной работы кэширования SQL-запросов необходима установка WEBO Site SpeedUp на уровне системного расширения (а не в качестве отдельного приложения).');
...
define('_WEBO_sql_cache_timeout_DISABLED', 'Для корректной работы кэширования SQL-запросов необходима установка WEBO Site SpeedUp на уровне системного расширения (а не в качестве отдельного приложения).');
...
define('_WEBO_sql_cache_tables_exclude_DISABLED', 'Для корректной работы кэширования SQL-запросов необходима установка WEBO Site SpeedUp на уровне системного расширения (а не в качестве отдельного приложения).');
...
define('_WEBO_WIZARD_STEP12_INFO', 'Все файлы стилей сайта автоматически объединяются и минимизируются, чтобы максимально ускорить отображение сайта в браузере.');
define('_WEBO_WIZARD_STEP122', 'Сжатие CSS');
define('_WEBO_WIZARD_STEP13', 'Оптимизация JavaScript');
define('_WEBO_WIZARD_STEP13_INFO', 'Все файлы скриптов сайта автоматически объединяются и минимизируются, чтобы уменьшить время загрузки сайта.');
define('_WEBO_WIZARD_STEP132', 'Сжатие JavaScript');
define('_WEBO_WIZARD_STEP14', 'Оптимизация HTML');
define('_WEBO_WIZARD_STEP14_INFO', 'HTML-код страницы сжимается и минимизируется, также в процессе оптимизации удаляются HTML-комментарии.');
define('_WEBO_WIZARD_STEP142', 'Сжатие HTML');
define('_WEBO_WIZARD_STEP15', 'data:URI');
define('_WEBO_WIZARD_STEP15_INFO', 'Идет проверка поддержки технологий data:URI и mhtml для уменьшения числа фоновых изображений.');
...
define('_WEBO_WIZARD_STEP31_INFO', 'В результате оптимизации сайт был полностью ускорен. Пожалуйста, включите ускорение, если с сайтом все в порядке.');
define('_WEBO_WIZARD_STEP31_INFO2', 'При включении ускорения все настройке будут сохранены в новой конфигурации, и WEBO Site SpeedUp будет включен. Рекомендуется проверить сайт после включения ускорения на предмет возможных артефактов.');
define('_WEBO_WIZARD_STEP31_LIST', 'Не удалось настроить следующие параметры:');
define('_WEBO_WIZARD_STEP31_LIST2', 'Вы можете');
define('_WEBO_WIZARD_STEP31_LIST3', 'настроить их самостоятельно');
define('_WEBO_WIZARD_STEP31_LIST4', 'заказать проверку конфигурации');
define('_WEBO_WIZARD_STEP31_LIST5', 'у специалистов WEBO Software.');
