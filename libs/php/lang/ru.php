...
define('_WEBO_WIZARD_STEP211_HELP', 'На сайте есть изменяющееся содержание, такое как корзина товаров или личный кабинет. Разные посетители видят страницы сайта по-раному.');
define('_WEBO_WIZARD_STEP212', 'Сайт можно полностью кэшировать');
define('_WEBO_WIZARD_STEP212_HELP', 'Сайт не содержит динамических элементов, таких как корзина товаров или личный кабинет. Все страницы сайта выглядят одинаково для всех пользователей сайта.');
