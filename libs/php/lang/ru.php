...
define('_WEBO_SYSTEM_hosts_possibility', 'Недоступны множественные хосты');
define('_WEBO_SYSTEM_hosts_possibility_HELP', 'Следующие поддомены не обеспечивают зеркалирование сайта: img, img1, img2, img3, img4, i, i1, i2, i3, i4, image, images, assets, static, css, js. Отсутствие поддоменов для зеркалирования делает невозможным применение опции "Множественные хосты" в WEBO Site SpeedUp. Для подключения указанных поддоменов (достаточно любых четырех) обратитесь к вашему хостинг-провайдеру или системному администратору либо настройте зеркалирование вручную.');
