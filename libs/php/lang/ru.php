...
define('_WEBO_html_cache_ignore_list_HELP', 'Вы также можете отключить кэширование страниц для пользователей, у которых заданы указанные COOKIE. Это бывает полезно для авторизованных пользователей или при работе с покупательской корзиной.');
