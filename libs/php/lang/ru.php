...
define('_WEBO_minify_js_HELP_DISABLED', 'Текущее серверное окружение не поддерживает запуск кнсольного java-приложения через PHP, поэтому сжатие при помощи YUI Compressor невозможно.');
...
define('_WEBO_data_uris_mhtml_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка "Производительность - Использовать файлы в кэше для всех браузеров".');
...
define('_WEBO_data_uris_size_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка "Производительность - Использовать файлы в кэше для всех браузеров".');
...
define('_WEBO_data_uris_mhtml_size_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка "Производительность - Использовать файлы в кэше для всех браузеров".');
...
define('_WEBO_data_uris_ignore_list_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка "Производительность - Использовать файлы в кэше для всех браузеров".');
...
define('_WEBO_data_uris_domloaded_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка "Производительность - Использовать файлы в кэше для всех браузеров".');
...
define('_WEBO_css_sprites_ignore_list', 'Исключать из CSS Sprites файлы (через пробел)');
...
define('_WEBO_SYSTEM_javascript_writable_HELP', 'Пожалуйста, проверьте права для директории JavaScript-кэша, которая указана на странице "Состояние системы" (вкладка "Параметры"). Необходимо либо изменить эту директорию на доступную, либо выполнить для нее CHMOD 775 или CHMOD 777.');
define('_WEBO_SYSTEM_css_writable', 'CSS-директория не доступна');
define('_WEBO_SYSTEM_css_writable_HELP', 'Пожалуйста, проверьте права для директории CSS-кэша, которая указана на странице "Состояние системы" (вкладка "Параметры"). Необходимо либо изменить эту директорию на доступную, либо выполнить для нее CHMOD 775 или CHMOD 777.');
define('_WEBO_SYSTEM_html_writable', 'HTML-директория не доступна');
define('_WEBO_SYSTEM_html_writable_HELP', 'Пожалуйста, проверьте права для директории HTML-кэша, которая указана на странице "Состояние системы" (вкладка "Параметры"). Необходимо либо изменить эту диреторию на доступную, либо выполнить для нее CHMOD 775 или CHMOD 777.');
define('_WEBO_SYSTEM_config_writable', 'Конфигурационный файл не доступен');
define('_WEBO_SYSTEM_config_writable_HELP', 'Пожалуйста, проверьте права для файла config.webo.php, расположенного в установочной директории WEBO Site SpeedUp. Вам нужно выполнять для него CHMOD 664 или CHMOD 666.');
define('_WEBO_SYSTEM_htaccess_writable', '<code>.htaccess</code> не доступен');
define('_WEBO_SYSTEM_htaccess_writable_HELP', 'Пожалуйста, проверьте права для файла .htaccess, расположенного в корне сайта. Нужно выполнить для него CHMOD 664 или CHMOD 666. Если в корневой директории сайта нет указанного файла, пожалуйста, разрешите в нее запись (CHMOD 775 или CHMOD 777) или создайте в ней файл .htaccess, доступный для записи.');
define('_WEBO_SYSTEM_index_writable', '<code>index.php</code> не доступен');
define('_WEBO_SYSTEM_index_writable_HELP', 'Пожалуйста, проверьте права для файла index.php, расположенного в корне сайта. Он должен быть доступен на запись, чтобы вставить в него вызовы WEBO Site SpeedUp. Вы можете оставить его недоступным для записи, но в этом случае вносить вызовы WEBO Site SpeedUp придется вручную. Более подробно этот вопрос освещен на странице "Состояние системы" (вкладка "Установка / Удаление"). Чтобы разрешить запись в файл index.php, пожалуйста, выполните для него CHMOD 664 или CHMOD 666.');
define('_WEBO_SYSTEM_curl_possibility', 'Расширение <code>curl</code> не доступно');
define('_WEBO_SYSTEM_curl_possibility_HELP', 'На сервере не установлено PHP-расширение curl. Оно используется для получения внешних и динамических файлов (для дальнейшего их объединения или кэширования). Для установки этого расширения, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно достаточно переустановить PHP, включив это расширение. [http://ru.php.net/curl Информация о curl на php.net] и [http://curl.haxx.se/libcurl/php/iis.html советы по установке curl для IIS].');
define('_WEBO_SYSTEM_gzip_possibility', 'Расширение <code>zlib</code> не доступно');
define('_WEBO_SYSTEM_gzip_possibility_HELP', 'На сервере не установлено PHP-расширение zlib. Оно используется для сжатия текстовых файлов "на лету", что экономит около 80% передаваемых данных. Для установки этого расширения, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно достаточно переустановить PHP, включив это расширение. [http://ru.php.net/manual/en/book.zlib.php Информация о zlib на php.net] и [http://ru.php.net/manual/en/install.windows.extensions.php информация о расширении zlib для Windows-окружений].');
define('_WEBO_SYSTEM_gd_possibility', 'Расширение <code>gd</code> не доступно');
define('_WEBO_SYSTEM_gd_possibility_HELP', 'На сервере не установлено PHP-расширение gd. Оно используется для создания CSS Sprites. Для установки этого расширения, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно достаточно переустановить PHP, включив это расширение. [http://ru.php.net/manual/en/book.image.php Информация о gd на php.net] и [http://php.net/manual/en/install.windows.extensions.php информация о расширении zlib для Windows-окружений].');
define('_WEBO_SYSTEM_gd_full_support', 'Расширение <code>gd</code> доступно частично');
define('_WEBO_SYSTEM_gd_full_support_HELP', 'На сервере установлено PHP-расширения gd, но доступен не весь функционал. Это может привести к некорректному созданию CSS Sprites. Для установки этого расширения со всеми функциями, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно достаточно переустановить PHP, включив это расширение. [http://ru.php.net/manual/en/book.image.php Информация о gd на php.net] и [http://php.net/manual/en/install.windows.extensions.php информация о расширении zlib для Windows-окружений].');
define('_WEBO_SYSTEM_yui_possibility', 'YUI Compressor не доступен');
define('_WEBO_SYSTEM_yui_possibility_HELP', 'Функция shell_exec не разрешена для вашего сайта, либо не доступна java. YUI Compressor выполняется как бинарное java-приложение и лучше (по сравнению с JSMin) уменьшает JavaScript-файлы в размере. Чтобы разрешить функцию shell_exec или установить java, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно достаточно разрешить shell_exec в PHP-конфигурации или установить java на веб-сервер. [http://ru.php.net/manual/en/function.shell-exec.php Информация о shell_exec на php.net] и [http://www.java.com/en/download/help/5000010500.xml информация об установке java для Linux-окружений].');
define('_WEBO_SYSTEM_hosts_possibility', 'Нет множественных хостов');
define('_WEBO_SYSTEM_hosts_possibility_HELP', 'Поддомены по умолчанию (img, img1, img2, img3, img4, i, i1, i2, i3, i4, image, images, assets, static, css, js), по-видимому, не обеспечивают зеркалирование сайта. С этим, в принципе, нет никаких проблем, если используются другие поддомены для распределения картинок. Для подключения указанных поддоменов (достаточно первых четырех), пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору.');
define('_WEBO_SYSTEM_mod_deflate', 'Нет поддержки <code>mod_deflate</code> + <code>mod_filter</code>');
define('_WEBO_SYSTEM_mod_deflate_HELP', 'На сайте нет поддержки mod_deflate, или mod_filter, или обоих сразу. Связка mod_deflate + mod_filter используется для архивирования ресурсов "на лету" на уровне Apache2. Для подключения этих модулей, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно они включено в Apache2 по умолчанию. [http://server-tuning.info/apache/content-compressing.html Подробнее о mod_deflate]');
define('_WEBO_SYSTEM_mod_gzip', 'Нет поддержки <code>mod_gzip</code>');
define('_WEBO_SYSTEM_mod_gzip_HELP', 'На сайте нет поддержки mod_gzip, который используется для сжатия ресурсов "на лету" на уровне Apache1. Для подключения этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://webo.in/articles/all/mod-gzip-minify-on-fly/ Подробнее о mod_gzip]');
define('_WEBO_SYSTEM_mod_headers', 'Нет поддержки <code>mod_headers</code>');
define('_WEBO_SYSTEM_mod_headers_HELP', 'На сайте нет поддержки mod_headers, который используется для улучшения сжатия для различных браузеров (исключения тех, которые его не поддерживают) и для отключения использования ETag. Для подключения этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://www.websiteoptimization.com/speed/tweak/cache/ Руководство по подключению mod_headers] и [http://httpd.apache.org/docs/2.0/mod/mod_headers.html подробнее о mod_headers]');
define('_WEBO_SYSTEM_mod_expires', 'Нет поддержки <code>mod_expires</code>');
define('_WEBO_SYSTEM_mod_expires_HELP', 'На сайте нет поддержки mod_expires, который используется для добавления кэширующих заголовков для статических файлов. Для подключения этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://www.websiteoptimization.com/speed/tweak/cache/ Руководство по подключению mod_expires] и [http://httpd.apache.org/docs/2.0/mod/mod_expires.html подробнее о mod_expires]');
define('_WEBO_SYSTEM_mod_mime', 'Нет поддержки <code>mod_mime</code>');
define('_WEBO_SYSTEM_mod_mime_HELP', 'На сайте нет поддержки mod_mime, который используется (в связке с mod_rewrite) для статического сжатия текстовых файлов. Для подключения этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://www.debuntu.org/2006/06/15/66-how-to-enable-apache-modules-under-debian-based-system Руководство по подключению mod_mime для Ubuntu] и [http://httpd.apache.org/docs/1.3/mod/mod_mime.html подробнее о mod_mime]');
define('_WEBO_SYSTEM_mod_setenvif', 'Нет поддержки <code>mod_setenvif</code>');
define('_WEBO_SYSTEM_mod_setenvif_HELP', 'На сайте нет поддержки mod_setenvif, который используется для улучшения сжатия для различных браузеров (исключения тех, которые его не поддерживают). Для подключения этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://www.debuntu.org/2006/06/15/66-how-to-enable-apache-modules-under-debian-based-system Руководство по подключению mod_mime для Ubuntu] и [http://httpd.apache.org/docs/1.3/mod/mod_setenvif.html подробнее о mod_setenvif]');
define('_WEBO_SYSTEM_mod_rewrite', 'Нет поддержки <code>mod_rewrite</code>');
define('_WEBO_SYSTEM_mod_rewrite_HELP', 'На сайте нет поддержки mod_rewrite, который используется для статического сжатия текстовых файлов (вместе с mod_mime) и для обеспечения клиентского кэширования в случае отсутствия mod_expires. Для подключения этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://www.tutorio.com/tutorial/enable-mod-rewrite-on-apache Руководство по подключению mod_rewrite] and [http://httpd.apache.org/docs/1.3/mod/mod_rewrite.html подробнее о mod_rewrite]');
define('_WEBO_SYSTEM_mod_symlinks', 'Нет поддержки <code>SymLinks</code>');
define('_WEBO_SYSTEM_mod_symlinks_HELP', 'На сайте нет поддержки SymLinks, которые используются вместе с mod_rewrite для более корректного перенаправления внутри вашей HTML-директории в случае символических ссылок. Обычно отсутствие данной возможности никак не сказывается на работспособности, но иногда может привести к некорректного перенаправлению запросов. Для подключения этой настройки, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://www.elharo.com/blog/software-development/web-development/2006/01/02/two-tips-for-fixing-apache-problems/ Подробнее о SymLinks]');
define('_WEBO_SYSTEM_protected_mode', 'Незащищенный режим работы');
define('_WEBO_SYSTEM_protected_mode_HELP', 'Установка WEBO Site SpeedUp не защищена через .htpasswd. В этой нет никакой проблемы, но если вы очень беспокоитесь о безопасности вашего сайта, то необходимо установить имя пользователя и пароль для .htpasswd на странице "Состояние системы" (вкладка "Параметры"). [http://httpd.apache.org/docs/1.3/programs/htpasswd.html Подробнее о .htpasswd]');
define('_WEBO_SYSTEM_cms', 'Нет поддержки CMS');
define('_WEBO_SYSTEM_cms_HELP', 'WEBO Site SpeedUp не поддерживает данную CMS. Вам необходимо вручную добавить требуемые вызовы в исходные файлы системы. Более подробная информация приведена на странице "Состояние системы" (вкладка "Установка/Удаление").');
define('_WEBO_SYSTEM_memory_limit', 'Память ограничена');
define('_WEBO_SYSTEM_memory_limit_HELP', 'На сайте существенно ограничено использование памяти. Это может привести к сбоям при создании CSS Sprites или data:URI. Для увеличения доступной памяти, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. [http://www.wallpaperama.com/forums/how-to-change-memory-limit-php-apache-server-t53.html Подробнее о пределе памяти в PHP]');
