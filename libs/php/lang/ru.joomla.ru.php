 ...
 * Contains all RU localization constants, special edition for joomla.ru
 *
 **/
...
define('_WEBO_GENERAL_BUYNOWZERO', '<a href="http://www.softkey.ru/catalog/basket.php?id=582705&amp;act=buy&amp;from=1722979" class="wssJ" title="WEBO Site SpeedUp Начальная версия">Купить</a>');
...
define('_WEBO_GENERAL_PULSAR', 'http://webopulsar.ru/license/');
...
define('_WEBO_minify_javascript', 'Объединение JavaScript-файлов в тэге <code>&lt;head&gt;</code>');
define('_WEBO_minify_javascript_HELP', 'Будет объединяться только JavaScript, подключенный в тэге &lt;head&gt;.');
define('_WEBO_minify_javascript_body', 'Объединение JavaScript-файлов в тэге <code>&lt;body&gt;</code>');
define('_WEBO_minify_javascript_body_HELP', 'Будет объединяться только JavaScript, подключенный в тэге &lt;body&gt;.');
define('_WEBO_external_scripts_inline', 'Объединять встроенный JavaScript-код в тэге <code>&lt;head&gt;</code>');
define('_WEBO_external_scripts_inline_HELP', 'Будет объединяться как код, содержащийся в тэгах &lt;script&gt;. Это коснется только содержимого тега &lt;head&gt;.');
define('_WEBO_external_scripts_inline_body', 'Объединять встроенный JavaScript-код в тэге <code>&lt;body&gt;</code>');
define('_WEBO_external_scripts_inline_body_HELP', 'Будет объединяться как код, содержащийся в тэгах &lt;script&gt; Это коснется только содержимого тега &lt;body&gt;.');
...
define('_WEBO_external_scripts_include_mask', 'Маска объединения скриптов');
define('_WEBO_external_scripts_include_mask_HELP', 'Вы можете задать маску для включения или исключения тегов script из итогового объединенного файла. Например, у вас идут 3 тега script, которые вы хотите включить в итоговый файл, а за ними &mdash; два, которые вы не хотите включать. В этом случае маска будет xxx00. Если не задано никакой маски, соответствующей текущему тегу script в документе, он будет включаться или исключаться согласно остальным правилам.');
...
define('_WEBO_minify_css_min4', 'Минимизировать с помощью YUI CSS compressor');
...
define('_WEBO_minify_js5', 'Минимизировать с помощью Google Compiler');
...
define('_WEBO_html_cache_timeout_cart', 'Время кэширования корзины интернет-магазина (в секундах)');
define('_WEBO_html_cache_timeout_cart_HELP', 'В течение этого времени все данные о пользовательской корзине будут храниться локально у пользователя (в cookie или localStorage).');
define('_WEBO_html_cache_timeout_cart_EFFECT', 'Улучшение взаимодействия пользователя с сайтом');
define('_WEBO_html_cache_timeout_ajax', 'Время кэширования AJAX-запросов (в секундах)');
define('_WEBO_html_cache_timeout_ajax_HELP', 'В течение этого времени все AJAX-запросы к сайту будут закэшированы на сервере.');
define('_WEBO_html_cache_timeout_ajax_EFFECT', 'Улучшение поведения сайта');
...
define('_WEBO_html_cache_ignore', 'Включить / исключить URL из HTML-кэша');
define('_WEBO_html_cache_ignore_HELP', 'Все перечисленные ниже URL будут либо исключены при кэшировании, либо будут кэшироваться только указанные в данном списке URL.');
define('_WEBO_html_cache_ignore1', 'Исключить следующие URL из HTML-кэша');
define('_WEBO_html_cache_ignore2', 'Включить кэширование только для следующих URL');
define('_WEBO_html_cache_ignore_list', 'Список URL или их частей (через пробел)');
define('_WEBO_html_cache_ignore_list_HELP', 'Часто серверное кэширование неприменимо для страниц с динамически изменяемыми параметрами, например, для страниц аккаунта пользователя, страниц статистики и других. Данное поле позволяет указать части (маски) URL страниц, которые не следует кэшировать на сервере. Также можно задать # для главной страницы.');
...
define('_WEBO_html_cache_cleanup', 'Удалять старые файлы');
define('_WEBO_html_cache_cleanup_HELP', 'После заданного времени существования серверного кэша все записи в нем будут удалены. Это повышает эффективность кэширования и позволяет форсировать обновление сайта для пользователей.');
define('_WEBO_html_cache_cleanup_EFFECT', 'Увеличение эффективности серверного кэширования');
...
define('_WEBO_data_uris_on_HELP_DISABLED', 'Создание data:URI невозможно, потому что отключено объединение CSS-файлов.');
...
define('_WEBO_data_uris_mhtml_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка &laquo;Производительность - Использовать файлы в кэше для всех браузеров&raquo; или отключено объединение CSS-файлов.');
...
define('_WEBO_data_uris_size_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка &laquo;Производительность - Использовать файлы в кэше для всех браузеров&raquo; или отключено объединение CSS-файлов.');
...
define('_WEBO_data_uris_mhtml_size_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка &laquo;Производительность - Использовать файлы в кэше для всех браузеров&raquo; или отключено объединение CSS-файлов.');
...
define('_WEBO_data_uris_ignore_list_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка &laquo;Производительность - Использовать файлы в кэше для всех браузеров&raquo; или отключено объединение CSS-файлов.');
...
define('_WEBO_data_uris_additional_list_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка &laquo;Производительность - Использовать файлы в кэше для всех браузеров&raquo; или отключено объединение CSS-файлов.');
...
define('_WEBO_data_uris_separate_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка &laquo;Производительность - Использовать файлы в кэше для всех браузеров&raquo; или отключено объединение CSS-файлов.');
...
define('_WEBO_css_sprites_enabled_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy. Либо нужно включить объединение CSS-файлов.');
...
define('_WEBO_css_sprites_aggressive_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy. Либо нужно включить объединение CSS-файлов.');
...
define('_WEBO_css_sprites_no_ie6_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy. Либо нужно включить объединение CSS-файлов.');
...
define('_WEBO_css_sprites_dimensions_limited_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy. Либо нужно включить объединение CSS-файлов.');
define('_WEBO_css_sprites_sprites_limited', 'Максимальная ширина и высота Sprites (в px)');
define('_WEBO_css_sprites_sprites_limited_HELP', 'Sprites будут ограничены заданным значением. Отсутствие значения или нулевое значение означает отсутствие ограничения.');
define('_WEBO_css_sprites_sprites_limited_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно.');
...
define('_WEBO_css_sprites_extra_space_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy. Либо нужно включить объединение CSS-файлов.');
...
define('_WEBO_css_sprites_truecolor_in_jpeg_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy. Либо нужно включить объединение CSS-файлов.');
...
define('_WEBO_htaccess_mod_deflate_HELP', 'Требуется для динамического сжатия файлов и является альтернативой использованию gzip.');
...
define('_WEBO_htaccess_mod_gzip_HELP', 'Требуется для динамического сжатия файлов и является альтернативой deflate.');
define('_WEBO_htaccess_mod_gzip_HELP_DISABLED', 'Текущее серверное окружение не поддерживает .htaccess, web.config и(ли) mod_gzip.');
...
define('_WEBO_htaccess_mod_expires_HELP_DISABLED', 'Текущее серверное окружение не поддерживает .htaccess, web.config и(ли) mod_expires.');
...
define('_WEBO_htaccess_mod_rewrite_HELP_DISABLED', 'Текущее серверное окружение не поддерживает .htaccess, web.config и(ли) mod_rewrite.');
define('_WEBO_iis_enabled', 'Использовать <code>web.config</code>');
define('_WEBO_iis_local', 'Расположить <code>web.config</code> в локальной (не корневой) директории');
define('_WEBO_iis_mod_deflate', 'Использовать <code>DEFLATE</code>');
define('_WEBO_iis_mod_gzip', 'Использовать <code>httpCompression</code>');
define('_WEBO_iis_mod_expires', 'Использовать <code>clientCache</code>');
define('_WEBO_iis_mod_headers', 'Использовать <code>HEADERS</code>');
define('_WEBO_iis_mod_setenvif', 'Использовать <code>SETENVIF</code>');
define('_WEBO_iis_mod_mime', 'Использовать <code>MIME</code>');
define('_WEBO_iis_mod_rewrite', 'Использовать <code>rewrite</code>');
define('_WEBO_rocket_css', 'Использовать WEBO Rocket для CSS');
define('_WEBO_rocket_css_HELP', 'Содержимое всех ваших CSS-файлов будет включено напрямую в HTML-код, а сами файлы запрошены после загрузки всей страницы. Это позволит существенно сократить время загрузки для как первоначальных, так и повторных просмотров страниц сайта.');
define('_WEBO_rocket_css_EFFECT', 'Общее время загрузки сайта будет уменьшено на 20-30%.');
...
define('_WEBO_parallel_regexp', 'Регулярное выражение');
define('_WEBO_parallel_regexp_HELP', 'Можно задать собственное регулярное выражение, которое будет выбрать все необходимые изображения для распределения по нескольким хостам или CDN. Например, &lt;(img|input)[^&gt;]+(src)[^&gt;]+&gt; или &lt;(img|input|div)[^&gt;]+(data-src|[^-]src|data-thumb)[^&gt;]+&gt;. Первый и второй параметр в регулярном выражении используются для корректной замены адреса изображения.');
define('_WEBO_parallel_regexp_EFFECT', 'Увеличение скорости загрузки сайта на 5-7%');
...
define('_WEBO_footer_text_HELP', 'Ссылка на WEBO Site SpeedUp является обязательным требованием для бесплатной версии и может быть убрана только в платной версии.');
...
define('_WEBO_footer_counter_HELP', 'При сборе статистики посещаемости по сайту через Google Analytics данные о времени загрузки сайта будут попадать в События. Необходимо задать ID вашего аккаунта в Google Analytics (например, UA-123456-7).');
...
define('_WEBO_DASHBOARD_AVAILABLE', 'Доступно в стандартной версии');
...
define('_WEBO_SYSTEM_webconfig_writable', 'Недоступен для записи файл <code>web.config</code>');
define('_WEBO_SYSTEM_webconfig_writable_HELP', 'Пожалуйста, сделайте файл web.config, расположенный в корневой директории сайта, доступным для записи. Если в корневой директории сайта нет этого файла, пожалуйста, разрешите запись в корневую директорию или вручную создайте в ней файл web.config, доступный для записи.');
...
define('_WEBO_SYSTEM_too_many_files', 'Кэш растет');
define('_WEBO_SYSTEM_too_many_files_HELP', 'На вашем сайте может быть расположен уникальный код, который препятствует эффективному созданию файлов в кэше. Если это предупреждение появляется регулярно, вам необходимо перенастроить WEBO Site SpeedUp, чтобы исключить уникальный код из кэширования.');
...
define('_WEBO_SYSTEM_google_possibility', 'Недоступен Google Compiler');
define('_WEBO_SYSTEM_google_possibility_HELP', 'Google Compiler невозможно выполнить как бинарное приложение java по одной из причин: либо не разрешена функция PHP shell_exec, либо недоступна java. Google Compiler обеспечивает лучшее, по сравнению с JSMin, сжатие файлов JavaScript. Для того, чтобы разрешить функцию shell_exec или установить java, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору. Обычно достаточно разрешить shell_exec в PHP-конфигурации или установить java на веб-сервер. [http://www.php.net/manual/en/function.shell-exec.php Информация о shell_exec на php.net] и [http://www.java.com/en/download/help/index_installing.xml информация об установке java].');
...
define('_WEBO_SPLASH2_COMPARISON_QUARANTEE', 'Гарантия ускорения');
define('_WEBO_SPLASH2_COMPARISON_REPORT', 'Отчет об ускорении');
define('_WEBO_SPLASH2_COMPARISON_SPEEDUP', 'Ускорение первой и повторной загрузки страниц');
define('_WEBO_SPLASH2_COMPARISON_BASIC', 'Базовые возможности для ускорения');
define('_WEBO_SPLASH2_COMPARISON_ADVANCED', 'Расширенные возможности для ускорения');
define('_WEBO_SPLASH2_COMPARISON_CPU', 'Снижение нагрузки на сервер');
define('_WEBO_SPLASH2_COMPARISON_SEO', 'Расширенная SEO-совместимость');
define('_WEBO_SPLASH2_COMPARISON_HTTPS', 'Интеграция с CDN');
define('_WEBO_SPLASH2_COMPARISON_PARTLY', 'Частичная');
define('_WEBO_SPLASH2_COMPARISON_COMPLETE', 'Полная');
define('_WEBO_SPLASH2_COMPARISON_CPU_MS', 'мс');
define('_WEBO_SPLASH2_COMPARISON_ANDMORE', 'и даже больше');
...
define('_WEBO_GZIP_BACKUP', 'Резервное копирование');
define('_WEBO_GZIP_ENTERBACKUP', 'Для каждого измененного файла будет создана резервная копия с расширением .backup');
...
define('_WEBO_HELP_LICENSEKEY2', 'зарегистрируйте ваш лицензионный ключ или получите SaaS-ключ, открывающий все возможности Полной версии WEBO Site SpeedUp. Вы можете пропустить этот шаг, если хотите использовать бесплатную версию WEBO Site SpeedUp.');
...
define('_WEBO_AWARDS_MIDDLE_INFO', 'Меньший по размеру сайт загружается быстрее у всех пользователей независимо от скорости подключения. Уменьшение размера сайта подсчитывается при помощи сервиса <a href="http://webopulsar.ru/">WEBO Pulsar</a>.');
...
define('_WEBO_AWARDS_BOTTOM_INFO', 'Скорость загрузки сайта является одним из важнейших факторов, удерживающих посетителей. Ускорение сайта подсчитывается при помощи сервиса <a href="http://webopulsar.ru/">WEBO Pulsar</a>.');
...
спасибо за установку WEBO Site SpeedUp на сайте ###WEBSITE###. Мы рады, что вы осознаете влияние скорости сайта на эффективность бизнеса, и что вам не безразлично, как пользователи чувствуют себя на вашем сайте.

Но обязаны предупредить: в случае неправильной настройки WEBO Site SpeedUp сайт может перестать работать.

Если в результате неправильной настройки сайт перестанет работать, не беспокойтесь, WEBO Site SpeedUp не изменяет исходных кодов вашего сайта и не изменяет базу данных. Даже если панель администратора сайта будет недоступна, отключить программу легко:

* Восстановите файл .htaccess в корневой директории вашего сайта или просто удалите из него все инструкции между комментариями # Web Optimizer. Резервная копия файла расположена в той же директории и называется .htaccess.backup.
* Откройте файл ###FOLDER###/config.webo.php и измените значение параметра $compress_options[\'active\'] с "1" на "0".

WEBO Site SpeedUp является лишь инструментом. Результат зависит от того, как он будет применен. Для разных серверных окружений требуются различные настройки. Особенности CSS и JavaScript также накладывают ограничения на методы ускорения сайта.

Краткое руководство по работе с продуктом

1. Подготовьтесь к работе.
* Выполните резервное копирование сайта, а также убедитесь, что во время ускорения на сайте не будут вестись какие-либо другие работы. В этом случае, если что-то пойдет не так, вы всегда сможете вернуться к стабильной версии сайта.
* Подготовьте инструменты для отладки веб-приложений. Мы рекомендуем использовать для этих целей браузер Firefox с дополнениями:
...
* Составьте список всех ключевых страниц и функций сайта. В результате работы необходимо достичь максимальной производительности этих страниц, разумеется, без ущерба их функционалу.
* Соберите информацию о существующих проблемах (проблемы верстки, ошибках JavaScript и т.п.). В случае если после ускорения сайта с помощью WEBO Site SpeedUp на сайте останутся какие-то проблемы, вы будете точно знать их источник.
* Проверьте ключевые страницы при помощи сервиса http://www.webpagetest.org/ сохранив ссылки на отчеты, чтобы к ним можно было вернуться позднее. Проверять необходимо из типичной для посетителей сайта географической точки, выполнять первую и повторную загрузку, а также проверять сериями из 5-10 тестов для получения репрезентативной выборки. Наиболее важные параметры, на которые следует обратить внимание, - время ответа сервера, время начала отрисовки, время полной загрузки, размер страницы.
* При помощи YSlow или PageSpeed определите основные проблемы со скоростью загрузки сайта. Чаще всего проблемы заключаются в отсутствии сжатия текстовых файлов, отсутствии кэширования, большом числе файлов и т.п. Все эти проблемы позволит решить WEBO Site SpeedUp.

2. Установите WEBO Site SpeedUp
* Перед установкой и настройкой отключите сторонние решения для ускорения сайта (объединение файлов, кэширование, минимизация, распределение файлов на CDN и т.п.). Подобные сторонние решения могут стать причиной неправильной работы WEBO Site SpeedUp.
* Выполните установку по инструкции. Наиболее часто возникающие при установке проблемы описаны в соответствующих разделах инструкции.
	o http://www.webogroup.com/ru/home/site-speedup/installation/
	o http://code.google.com/p/web-optimizator/wiki/IntegrationWithWebsite?wl=ru
* Если вам известно о проблемах в установленной версии WEBO Site SpeedUp, попробуйте обновить продукт до последней бета-версии на странице Состояние системы в интерфейсе модуля.
* После успешной установки в интерфейсе модуля откройте вкладку Состояние системы и проверьте, что там не выводится сообщений об ошибках. Также обратите внимание на информационные сообщения, которые выведет WEBO Site SpeedUp. Они могут быть полезны при настройке модуля.
* Убедитесь, что установленный (но пока не включенный) модуль не повлиял на работоспособность сайта и панели администратора сайта.
...
* На вкладке .htaccess проверьте, что включены все доступные модули Apache. Применение всех этих модулей упрощает настройку продукта и позволяет легко достичь оптимальной скорости работы сайта. Если каких-то модулей недостает, можно обратиться к администратору хостинга с просьбой добавить этот модуль. Заметьте, если на сайте работают какие-то другие веб-серверы помимо Apache, эти изменения могут не оказать никакого эффекта.
* На вкладке Клиентское кэширование, если кэширование статических файлов на сайте еще не производится, включите флаги для необходимых типов файлов. Учтите, что кэширование файлов HTML и внешних файлов может привести к неправильной работе сайта, если эти файлы изменяются динамически (например, если на сайте есть личный кабинет или корзина или страницы отображаются по-разному разным пользователям).
* На вкладке gzip-архивирование включите сжатие для тех типов файлов, которые еще не сжимаются.
* На вкладке Объединение CSS выберите подходящую для вашего сайта схему объединения. В большинстве случаев оптимальным является объединение всего кода CSS внутри тэга head включая встроенный код и внешние файлы. Объединенные файлы по умолчанию выводятся на странице на месте первой части кода, входящей в объединенный файл.
* На вкладке Объединение JS выберите подходящую для вашего сайта схему объединения файлов. Порядок кода в объединенном файле в точности соответствует исходному порядку на странице, поэтому наиболее оптимальный вариант — объединение всего кода в тэге head. Но учтите, что если в коде JavaScript содержатся уникальные для разных пользователей значения, такие области кода из объединения необходимо исключать, чтобы WEBO Site SpeedUp не создавал уникальные объединенные файлы в кэше для каждого нового пользователя сайта. Обычно это только замедляет его загрузку. Используйте возможность исключения файлов или встроенного кода из объединения, а также возможность переноса объединенного файла в конец секции head. Для лучшего понимания работы модуля сравните исходный код страницы при разных типах объединения. Обязательно проверяйте, что не нарушены зависимости кода и при включенном модуле в консоли браузера не появляется информации о новых ошибках JavaScript.
* На вкладке Минимизация настройте оптимальный режим удаления избыточного кода (комментариев, переносов строк и т.д.). Самым стабильным вариантом является минимизация CSS при помощи регулярных выражений, JS при помощи JSMin и простая минимизация HTML. В случае возникновения проблем минимизацию можно просто отключить. При наличии gzip-архивирования эффект от минимизации достаточно незначительный.
* На вкладке data:URI включите опцию data:URI (подстановки изображений в код CSS для уменьшения числа запросов к серверу). Оптимальным максимальным размером для таких изображений является 1000-3000 байт. Убедитесь, что размер файлов CSS с содержащимися в них изображениями не увеличился более чем на 20-50%, в противном случае время начала отрисовки страниц может значительно увеличиться.
* На вкладке CSS Sprites подберите наиболее оптимальную схему объединения изображений вызываемых в коде CSS и HTML. Объединение большого числа изображений может потребовать большого объема памяти и привести к неработоспособности сайта. Исключайте большие изображения из объединения в CSS Sprites по размерам или по имени файла либо выберите только необходимые изображения, задав их имена файлов.
* На вкладке Серверное кэширование установите время жизни кэша и включите кэширование. Используйте эту функцию с осторожностью и обязательно проверьте работу динамических страниц сайта, по необходимости исключите их из серверного кэширования. В противном случае сайт может работать неправильно.
* Если вы приобрели услуги CDN-провайдера или располагаете собственными серверами для распределения статического содержимого, настройте CDN на одноименной вкладке.
* Если на страницах сайта присутствуют рекламные блоки или счетчики или какой-то другой код JavaScript, блокирующий загрузку страниц, включите необходимые функции на странице Ненавязчивый JavaScipt.
* Не забывайте после каждого шага проверять работу сайта. Используйте YSlow или PageSpeed, чтобы убедиться в том, что включенные функции модуля принесли ожидаемый эффект. При возникновении проблем так будет легче всего определить, какие именно настройки были выбраны неверно и привели к неправильной работе сайта.

4. Проверьте результат
* Включите модуль WEBO Site SpeedUp и выполните итоговую проверку всех ключевых страниц и функций сайта в нескольких основных браузерах (IE8, Firefox, Safari).
* Повторно проверьте страницы в сервисе http://www.webpagetest.org/, сравните результаты с результатами из первых тестов.
* Повторно проверьте страницы при помощи YSlow и PageSpeed.
* Если какие-то проблемы связанные со скоростью работы сайта или с модулем WEBO Site SpeedUp остались не решены, вернитесь к настройке модуля.
* Прочтите памятку по работе с WEBO Site SpeedUp.

Часто задаваемые вопросы
1. Мы изменили код CSS или код JavaScript в исходных файлах, но не видим изменений на сайте. Почему?
Обычно кэш оптимизированных файлов CSS и JavaScript не обновляется автоматически при изменении содержимого исходных файлов в целях экономии серверных ресурсов.
Чтобы изменения вступили в силу добавить к вызову файла произвольный параметр (например, сегодняшнюю дату или версию файла, т.е. заменить вызов a.css на a.css?v=12), в этом случае код автоматически обновится как в кэше на сервере, так и в браузерах клиентов, которые уже посещали сайт.
Чтобы обновить кэш только на сервере, откройте панель управления WEBO Site SpeedUp и нажмите кнопку Обновить кэш. В этом случае потребуется ручное обновление кэша в браузере (в большинстве браузеров это делается при помощи CTRL+F5).

2. Мы внедряем новый дизайн и новый функционал на сайте и часто обновляем тексты, код CSS и JavaScript. Постоянно сбрасывать кэш очень неудобно. Что делать?
Отключите модуль в панели управления WEBO Site SpeedUp на время обновления, либо используйте GET-параметр web_optimizer_disabled=1 для тестирования страниц с отключенным модулем, например:
http://###WEBSITE###/?web_optimizer_disabled=1

3. Что если мы хотим убедиться, что новый дизайн и новый функционал будут совместимы с WEBO Site SpeedUp?
Отключите модуль в панели управления WEBO Site SpeedUp и используйте GET-параметр web_optimizer_debug=1 для тестирования с включенным модулем.

4. Некоторые страницы ускоренного сайта загружаются медленнее, чем другие (хотя и быстрее, чем до установки WEBO Site SpeedUp). Почему?
Скорее всего включено серверное кэширование, которое значительно увеличивает скорость появления страниц на экране, но в некоторых ситуациях может не работать. Возможные причины:
* Страница еще ни разу не была открыта с момента последней очистки кэша WEBO Site SpeedUp. В этом случае повторное открытие страницы произойдет быстрее.
* Страница была открыта и автоматически закэширована, но срок хранения истёк. Обычно этот срок составляет от нескольких часов до нескольких суток. В этом случае повторное открытие страницы произойдет быстрее.
* Есть препятствия для кэширования страниц, например, вы залогинены на сайте, находитесь на странице корзины или странице оформления товара и т.д. В случае, когда страницы, находящиеся по одному и тому же адресу должны отдаваться с разным содержимым для разных пользователей, серверное кэширование в ряде CMS может не работать.

5. Мы изменили тексты страниц, но не видим изменений на сайте.
Скорее всего включено серверное кэширование. Откройте панель управления WEBO Site SpeedUp и нажмите кнопку Обновить кэш.

6. Мы обнаружили проблемы на сайте и думаем, что причиной может быть WEBO Site SpeedUp.
Отключите модуль и попробуйте воспроизвести проблему. Если проблема не воспроизводится, пожалуйста, сообщите об этой проблеме нам по адресу support@webo.name .

7. После включения WEBO Site SpeedUp сайт оказался недоступен? Что делать?
Необходимо отключить WEBO Site SpeedUp. Все меры оптимизации при этом автоматически отменяются. Если отключить модуль через панель управления невозможно, выполните следующие два действия:
Откройте файл ###FOLDER###/config.webo.php и измените значение параметра $compress_options[\'active\'] с "1" на "0".
Восстановите исходный файл .htaccess в корневой директории вашего сайта из файла .htaccess.backup.

Техническая поддержка
Если вам нужен гарантированный результат, напишите на sales@webo.name и мы вышлем подробный отчет о возможном ускорении и рассчитаем стоимость работы.');
?>