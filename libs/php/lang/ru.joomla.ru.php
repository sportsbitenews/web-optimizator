...
define('_WEBO_parallel_enabled_HELP', 'Можно задать собственное регулярное выражение, которое будет выбрать все необходимые изображения для распределения по нескольким хостам или CDN. Например, &lt;(img|input)[^&gt;]+(src)[^&gt;]+&gt;. Первый и второй параметр в регулярном выражении используются для корректной замены адреса изображения.');
define('_WEBO_parallel_enabled_EFFECT', 'Увеличение скорости загрузки сайта на 5-7%');
