...
define('_WEBO_css_sprites_enabled_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy.');
...
define('_WEBO_css_sprites_aggressive_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy.');
...
define('_WEBO_css_sprites_no_ie6_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy.');
...
define('_WEBO_css_sprites_dimensions_limited_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy.');
...
define('_WEBO_css_sprites_extra_space_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy.');
...
define('_WEBO_css_sprites_truecolor_in_jpeg_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy.');
