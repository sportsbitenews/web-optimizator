...
define('_WEBO_html_cache_cleanup', 'Срок хранения кэша (в минутах)');
define('_WEBO_html_cache_cleanup_HELP', 'После заданного количества минут все записи в HTML кэше будут удалены. Это повышает эффективность кэширования и позволяет форсировать обновление сайта для пользователей.');
