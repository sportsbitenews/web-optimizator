...
define('_WEBO_html_cache_enhanced_HELP', 'В экстремальном режиме все HTML-документы будут отдаваться в обход обработке запросов на стороне системы управления сайтами. Это делает возможным только ручной сброс кэша, но существенно увеличивает производительность сайта (особенно в момент наплыва посещаемости).');
...
define('_WEBO_SYSTEM_javascript_writable', 'Недоступна для записи директория кэша JavaScript');
define('_WEBO_SYSTEM_javascript_writable_HELP', 'Пожалуйста, сделайте директорию кэша JavaScript доступной для записи (например, выполнив chmod 775 или chmod 777) либо выберите другую директорию на странице "Состояние системы", на вкладке "Параметры".');
define('_WEBO_SYSTEM_css_writable', 'Недоступна для записи директория кэша CSS');
define('_WEBO_SYSTEM_css_writable_HELP', 'Пожалуйста, сделайте директорию кэша CSS доступной для записи (например, выполнив chmod 775 или chmod 777) либо выберите другую директорию на странице "Состояние системы", на вкладке "Параметры');
define('_WEBO_SYSTEM_html_writable', 'Недоступна для записи директория кэша HTML');
define('_WEBO_SYSTEM_html_writable_HELP', 'Пожалуйста, сделайте директорию кэша HTML доступной для записи (например, выполнив chmod 775 или chmod 777) либо выберите другую директорию на странице "Состояние системы", на вкладке "Параметры".');
...
define('_WEBO_SYSTEM_curl_possibility_HELP', 'На сервере отсутствует расширение curl для PHP. Это расширение необходимо для получения внешних и динамических файлов для дальнейшего их объединения или кэширования. Для установки этого расширения, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите это расширение вручную. Обычно достаточно переустановить PHP, включив это расширение. [http://www.php.net/curl Информация о curl на php.net], [http://curl.haxx.se/libcurl/php/ советы по установке curl], [http://www.php.net/manual/en/install.windows.extensions.php информация по установке расширений в Windows] [http://www.php.net/manual/en/install.php и в Unix].');
define('_WEBO_SYSTEM_gzip_possibility', 'Недоступно расширение <code>zlib</code> для PHP');
define('_WEBO_SYSTEM_gzip_possibility_HELP', 'На сервере отсутствует расширение zlib для PHP. Это расширение необходимо для сжатия текстовых файлов "на лету". Для установки этого расширения, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите это расширение вручную. Обычно достаточно переустановить PHP, включив это расширение. [http://www.php.net/manual/en/book.zlib.php Информация о zlib на php.net], [http://www.php.net/manual/en/install.windows.extensions.php информация по установке расширений в Windows] [http://www.php.net/manual/en/install.php и в Unix].');
define('_WEBO_SYSTEM_gd_possibility', 'Недоступно расширение <code>gd</code> для PHP');
define('_WEBO_SYSTEM_gd_possibility_HELP', 'На сервере отсутствует расширение gd для PHP. Это расширение необходимо для создания CSS Sprites. Для установки этого расширения, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите это расширение вручную. Обычно достаточно переустановить PHP, включив это расширение. [http://www.php.net/manual/en/book.image.php Информация о gd на php.net], [http://www.php.net/manual/en/install.windows.extensions.php информация по установке расширений в Windows] [http://www.php.net/manual/en/install.php и в Unix].');
define('_WEBO_SYSTEM_wordpress_cache_enabled', 'Кэширование в WordPress отключено');
define('_WEBO_SYSTEM_wordpress_cache_enabled_HELP', 'Для использования серверного кэширования нужно добавить строку define (\'WP_CACHE\', true); в файл wp-config.php после строки, содержащей define(\'WPLANG\', ...) или сделать этот файл доступным для записи и деактивировать, а затем активировать Webo SiteSpeedup.');
define('_WEBO_SYSTEM_gd_full_support', 'Частично недоступно расширение <code>gd</code> для PHP');
define('_WEBO_SYSTEM_gd_full_support_HELP', 'На сервере частично отсутствует функционал PHP-расширения gd. Это может привести к некорректному созданию CSS Sprites. Для установки этого расширения с полным функционалом, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите это расширение вручную. Обычно достаточно переустановить PHP, включив это расширение. [http://www.php.net/manual/en/book.image.php Информация о gd на php.net], [http://www.php.net/manual/en/install.windows.extensions.php информация по установке расширений в Windows] [http://www.php.net/manual/en/install.php и в Unix].');
define('_WEBO_SYSTEM_yui_possibility', 'Недоступен YUI Compressor');
define('_WEBO_SYSTEM_yui_possibility_HELP', 'YUI Compressor невозможно выполнить, как бинарное приложение java по одной из причин: либо не разрешена функция PHP shell_exec, либо недоступна java. YUI Compressor обеспечивает лучшее, по сравнению с JSMin, сжатие файлов JavaScript. Для того, чтобы разрешить функцию shell_exec или установить java, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору либо совершите необходимые действия вручную. Обычно достаточно разрешить shell_exec в PHP-конфигурации или установить java на веб-сервер. [http://www.php.net/manual/en/function.shell-exec.php Информация о shell_exec на php.net] и [http://www.java.com/en/download/help/index_installing.xml информация об установке java].');
define('_WEBO_SYSTEM_hosts_possibility', 'Недоступны стандартные зеркальные хосты основного хоста');
define('_WEBO_SYSTEM_hosts_possibility_HELP', 'Следующие поддомены не обеспечивают зеркалирование: img, img1, img2, img3, img4, i, i1, i2, i3, i4, image, images, assets, static, css, js. Отсутствие поддоменов для зеркалирования делает невозможным применение некоторых опций из группы "CDN" в WEBO Site SpeedUp. Для подключения указанных поддоменов (достаточно любых четырех) обратитесь к вашему хостинг-провайдеру или системному администратору либо настройте зеркалирование вручную.');
define('_WEBO_SYSTEM_mod_deflate', 'Недоступны модули <code>mod_deflate</code> + <code>mod_filter</code> для Apache');
define('_WEBO_SYSTEM_mod_deflate_HELP', 'На сервере отстутствует либо модуль mod_deflate, либо модуль mod_filter, либо оба этих модуля. Связка mod_deflate + mod_filter применяется для сжатия ресурсов "на лету" на уровне Apache. Для установки этих модулей, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите их вручную. [Подробнее о http://httpd.apache.org/docs/2.0/mod/mod_deflate.html mod_deflate] и [http://httpd.apache.org/docs/2.1/mod/mod_filter.html mod_filter]');
define('_WEBO_SYSTEM_mod_gzip', 'Недоступен модуль <code>mod_gzip</code> для Apache');
define('_WEBO_SYSTEM_mod_gzip_HELP', 'На сервере отстутствует модуль mod_gzip, который применяется для сжатия ресурсов "на лету" на уровне Apache. Для установки этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите его вручную.  [http://schroepl.net/projekte/mod_gzip/ Подробнее о mod_gzip] и [http://webo.in/articles/all/mod-gzip-minify-on-fly/ его применении]');
define('_WEBO_SYSTEM_mod_headers', 'Недоступен модуль <code>mod_headers</code> для Apache');
define('_WEBO_SYSTEM_mod_headers_HELP', 'На сервере отстутствует модуль mod_headers, позволяющий применять сжатие только в браузерах, поддерживающих его. Этот модуль также позволяет отключать применение ETag. Для установки этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите его вручную. [http://httpd.apache.org/docs/2.0/mod/mod_headers.html Подробнее о mod_headers], [http://www.websiteoptimization.com/speed/tweak/cache/ руководство по подключению mod_headers].');
define('_WEBO_SYSTEM_mod_setenvif', 'Недоступен модуль <code>mod_setenvif</code> для Apache');
define('_WEBO_SYSTEM_mod_setenvif_HELP', 'На сервере отстутствует модуль mod_setenvif, позволяющий применять сжатие только в браузерах, поддерживающих его. Для установки этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите его вручную. [http://httpd.apache.org/docs/1.3/mod/mod_setenvif.html Подробнее о mod_setenvif]');
define('_WEBO_SYSTEM_mod_expires', 'Недоступен модуль <code>mod_expires</code> для Apache');
define('_WEBO_SYSTEM_mod_expires_HELP', 'На сервере отстутствует модуль mod_expires, который необходим для обеспечения кэширования статических файлов на стороне клиента. Для установки этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите его вручную. [http://httpd.apache.org/docs/2.0/mod/mod_expires.html Подробнее о mod_expires]');
define('_WEBO_SYSTEM_mod_mime', 'Недоступен модуль <code>mod_mime</code> для Apache');
define('_WEBO_SYSTEM_mod_mime_HELP', 'На сервере отстутствует модуль mod_mime, который необходим для статического сжатия текстовых файлов в связке с mod_rewrite. Для установки этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите его вручную. [http://httpd.apache.org/docs/1.3/mod/mod_mime.html Подробнее о mod_mime]');
define('_WEBO_SYSTEM_mod_rewrite', 'Недоступен модуль <code>mod_rewrite</code> для Apache');
define('_WEBO_SYSTEM_mod_rewrite_HELP', 'На сервере отстутствует модуль mod_rewrite, который применяется в связке с mod_rewrite для статического сжатия текстовых файлов, а также для обеспечения кэширования статических файлов на стороне клиента в случае отсутствия mod_expires. Для установки этого модуля, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору, либо установите его вручную. [http://httpd.apache.org/docs/1.3/mod/mod_rewrite.html Подробнее о mod_rewrite]');
define('_WEBO_SYSTEM_mod_symlinks', 'Отсутствует поддержка <code>SymLinks</code> для Apache');
define('_WEBO_SYSTEM_mod_symlinks_HELP', 'На сервере нет поддержки SymLinks, которая необходима для корректной работы mod_rewrite в случае использования символических ссылок. Обычно отсутствие данной возможности никак не сказывается на работспособности, но иногда может привести к некорректному перенаправлению запросов. Обратитесь к вашему хостинг-провайдеру или системному администратору, либо произведите настройку вручную. [http://www.elharo.com/blog/software-development/web-development/2006/01/02/two-tips-for-fixing-apache-problems/ Подробнее о SymLinks]');
...
define('_WEBO_SYSTEM_memory_limit_HELP', 'На сайте существенно ограничен объем доступной оперативной памяти. Это может привести к сбоям при создании CSS Sprites или data:URI. Для увеличения объема доступной памяти, пожалуйста, обратитесь к вашему хостинг-провайдеру или системному администратору или произведите реконфигурацию сервера вручную. [http://www.wallpaperama.com/forums/how-to-change-memory-limit-php-apache-server-t53.html Подробнее о пределе памяти в PHP]');
