...
define('_WEBO_minify_javascript', 'Об\'єднати JavaScript-файли в тэге <code>&lt;head&gt;</code>');
define('_WEBO_minify_javascript_HELP', 'В зависимости от выбранной опции JavaScript будет объединяться только JavaScript, подключенный в тэге &lt;head&gt;.');
define('_WEBO_minify_javascript_body', 'Об\'єднати JavaScript-файли в тэге <code>&lt;body&gt;</code>');
define('_WEBO_minify_javascript_body_HELP', 'В зависимости от выбранной опции JavaScript будет объединяться только JavaScript, подключенный в тэге &lt;body&gt;.');
define('_WEBO_external_scripts_inline', 'Включити об\'єднання JavaScript-кода в тэге <code>&lt;head&gt;</code>');
define('_WEBO_external_scripts_inline_HELP', 'Будет объединяться код, содержащийся в тэгах &lt;script&gt;. Это коснется только содержимого тега &lt;head&gt;.');
define('_WEBO_external_scripts_inline_body', 'Включити об\'єднання JavaScript-кода в тэге <code>&lt;body&gt;</code>');
define('_WEBO_external_scripts_inline_body_HELP', 'Будет объединяться код, содержащийся в тэгах &lt;script&gt;. Это коснется только содержимого тега &lt;body&gt;.');
...
define('_WEBO_minify_js5', 'Мінімізувати за допомогою Google Compiler');
...
define('_WEBO_html_cache_ignore_list', 'Перелік частин URL');
...
define('_WEBO_data_uris_additional_list_HELP_DISABLED', 'Создание кроссбраузерного data:URI невозможно, потому что включена настройка &laquo;Производительность - Использовать файлы в кэше для всех браузеров&raquo; или отключено объединение CSS-файлов или отключено объединение CSS-файлов.');
...
define('_WEBO_css_sprites_sprites_limited_HELP_DISABLED', 'Текущее серверное окружение не полностью поддерживает библиотеку GD, поэтому создание CSS Sprites невозможно. Либо для минимизации CSS не выбрана библиотека CSS Tidy.');
...
define('_WEBO_htaccess_enabled_HELP', 'Создает в корневой директории сайта файл .htaccess / web.config, либо модифицирует существующий файл, сохраняя все его исходное содержимое, а также создавая резервную копию исходного файла. Содержимое файла .htaccess / web.config изменяется в зависимости от других опций.');
...
define('_WEBO_iis_enabled', 'Включити <code>web.config</code>');
define('_WEBO_iis_local', 'Розмістити <code>web.config</code> в локальній (не кореневій) директорії');
define('_WEBO_iis_mod_deflate', 'Використовувати <code>DEFLATE</code>');
define('_WEBO_iis_mod_gzip', 'Використовувати <code>httpCompression</code>');
define('_WEBO_iis_mod_expires', 'Використовувати <code>clientCache</code>');
define('_WEBO_iis_mod_headers', 'Використовувати <code>HEADERS</code>');
define('_WEBO_iis_mod_setenvif', 'Використовувати <code>SETENVIF</code>');
define('_WEBO_iis_mod_mime', 'Використовувати <code>MIME</code>');
define('_WEBO_iis_mod_rewrite', 'Використовувати <code>rewrite</code>');
