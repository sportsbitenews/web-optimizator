...
define('_WEBO_NEW_PROTECT', '<p>Для забезпечення безпеки при подальшому використанні Web Optimizer необхідно встановили пароль доступу. <strong>Демонстрационная версия</strong> устанавливается без лицензионного ключа.</p><p>Перед проведенням установки, будь-ласка, переконайтеся, що кореневий <code>.htaccess</code>і файли веб-системи, яка використовується, доступні на запис (при проведенні установки Web Optimizer також створює резервні копії).</p><p>Web Optimizer може самостійно перевірити доступні можливості вашего серверу і провести установку в автоматичному режимі. Для цього необхідно обрати <strong>&laquo;Швидка установка&raquo;</strong>. В подальшому ви зможете змінити всі збережені налаштування, використовуючи даний інтерфейс.</p><p>Якщо Ви хочете налаштувати використання Web Optimizer самостійно, то необхідно обрати <strong>&laquo;Далі&raquo;</strong>. Ви зможете перевірити всі налаштування до їх застосування для вашого сайту.</p><p><a href="http://webo.in/articles/habrahabr/99-web-optimizer-installation-0.5/">Процес установки Web Optimizer</a></p>');
...
define('_WEBO_SPLASH2_WEBSITEROOT', 'Сайт розміщений в');
...
define('_WEBO_SPLASH2_MINIFY_INFO', '<p>Стиснення видаляє із CSS- та JavaScript-файлів пробіли, переводи рядків та інші непотрібні символи.</p><p>Ви також можете обрати один із декількох інструментів мінімізації або обфускації.</p><p>Будьте внимательными при удалении HTML-комментариев или применении сжатия в одну строку, первое может привести к удалению кодов счетчиков, а второе увеличит нагрузку на сервер каждый раз при создании страницы.</p><p><a href="http://webo.in/articles/habrahabr/14-minifing-css/">Стиснення CSS-</a> та <a href="http://webo.in/articles/habrahabr/11-minifing-javascript/">JavaScript-файлів</a>.</p>');
define('_WEBO_SPLASH2_EXTERNAL', 'Включити зовнішні файли');
define('_WEBO_SPLASH2_EXTERNAL_INFO', '<p>При активації цієї настройки всі JavaScript-файли, що підключаються із зовнішніх сайтів, так само як і просто JavaScript-код, який знаходиться в секції <code>head</code>, будуть об\'єднані в один файл, зменшені у розмірі і підключені відразу після CSS-файлу.</p><p>Це буде особливо корисним при використанні великої кількості модулів з різних сайтів, які не можуть бути підключені в &laquo;ненав\'язливому&raquo; режимі.</p><p>Ви також можете вказати імена файлів, які потрібно виключити з подібного об\'єдинання (наприклад, ga.js jquery.min.js).</p><p><a href="http://webo.in/articles/habrahabr/50-fast-fast-javascript/">Методи прискорення завантаження JavaScript</a>.</p>');
define('_WEBO_SPLASH2_UNOBTRUSIVE', '&laquo;Ненав\'язливий&raquo; JavaScript');
define('_WEBO_SPLASH2_UNOBTRUSIVE_INFO', '<p>&laquo;Ненав\'язливий&raquo; JavaScript-файли завантажуються відразу після відображення сторінки в браузері. Його використання може значно збільшити швидкість завантаження сторінки для кінцевих користувачів. Але в деяких випадках це може порушити працездатність сайту.</p><p>Рекомендується включати цю настройку тілько у випадку повної впевненості в існуючій клієнтській логіці.</p><p>Також існує можливість перенести всі виклики зовнішніх JavaScript-файлів перед <code>&lt;/body&gt;</code>.</p><p><a href="http://webo.in/articles/all/04-unobtrusive-javascript-operation-clean-up/">Техніка &laquo;ненав\'язливого&raquo; JavaScript</a>, <a href="http://webo.in/articles/habrahabr/44-unobtrusive-advertisements-basics/">&laquo;ненав\'язлива&raquo; реклама і лічильники</a>, <a href="http://webo.in/articles/habrahabr/56-non-blocking-javascript/">блокуючі скріпти</a> та <a href="http://webo.in/articles/habrahabr/05-delayed-loading/">&laquo;відкладене&raquo; завантаження</a>.</p>');
define('_WEBO_SPLASH2_MTIME', 'Не перевіряти актуальність');
define('_WEBO_SPLASH2_MTIME_INFO', '<p>Як правило, Web Optimizer при кожному завантаженні сторінки перевіряє, чи змінились файли (час зміни та їх вміст), і на основі цієї інформації або дає лінки на існуючі статичні файли, або створює нові.</p><p>З точки зору серверної оптимізації більш оптимально буде не перевіряти кожного разу, чи змінились файли, а видаляти по факту самої зміни закешовану версію. Із включенням цієї настройки вам буде необхідно самостійно управляти кешем Web Optimizer.</p><p><a href="http://webo.in/articles/all/10-frontend-backend-balancing/">Вплив кількості файлов, що підключаються, на швидкість завантаження</a>.</p>');
define('_WEBO_SPLASH2_GZIP', 'Настройки аархівування');
define('_WEBO_SPLASH2_GZIP_INFO', '<p>Застосування <code>gzip</code>-стискання дозволить на 80-85% зменшити розмір текстових файлів.</p><p>Для завантажених сайтів рекомендується настройки <code>gzip</code>-стискання перенести в конфігураційний файл сервера (або використовувати настройки <code>.htaccess</code> нижче).</p><p><a href="http://webo.in/articles/habrahabr/30-gzip-versus-broadband/">Ресурсоємність</a> та <a href="http://webo.in/articles/habrahabr/33-gzip-level-tool/">ефективність gzip-стискання</a>.</p>');
define('_WEBO_SPLASH2_EXPIRES', 'Клієнтське кешування');
define('_WEBO_SPLASH2_EXPIRES_INFO', '<p>В результаті роботи цієї настройки до всіх статичних файлів будуть додані заголовки кешування, які дозволять запобігти їх повторному запросу із сервера для одного і того ж користувача.</p><p>При зміні JavaScript- або CSS-файлів автоматично будуть створюватися їх нові мінімізовані версії, що дозволить &laquo;пробити&raquo; кеш в браузерах. Для малюнків та інших статичних файлів рекомендується використовувати нове фізичне ім\'я при їх зміні.</p><p><a href="http://webo.in/articles/all/http-caching/">Кешування </a> та <a href="http://webo.in/articles/habrahabr/15-yahoo-best-practices/#expires">його ефективність</a>.</p>');
define('_WEBO_SPLASH2_HTMLCACHE', 'Серверне кешування');
define('_WEBO_SPLASH2_HTMLCACHE_INFO', '<p>Web Optimizer може кешувати кінцевий HTML-код, чим відвертає значну частину роботи на стороні сервера і зменшує час створення сторінки.</p><p>Увага: при включенні цієї настройки вся логіка, що здійснюється на стороні серверу, буде недоступна. Сторінки стануть повністю статичними. Рекомендуєтся включати цю настройку, тільки якщо ви повністю впевнені у наслідках.</p><p><a href="http://webo.in/articles/all/2009/16-content-flushing/">Швидке скидання документу</a> та <a href="http://webo.in/articles/habrahabr/34-streaming-chunking-finding-end/">чанки</a>.</p>');
