...
define('_WEBO_css_sprites_sprites_limited_HELP_DISABLED', 'There is no complete GD library support on your website, so CSS Sprites creation is impossible. Or CSS Tidy library isn\'t selected to minify CSS.');
