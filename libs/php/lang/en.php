...
define('_WEBO_NEW_PROTECT', '<p class="wssI">Please enter username and password to protect this installation. <strong>Demo version</strong> requires no license key to be installed.</p><p class="wssI">Before installation please check that root <code>.htaccess</code> and source files of your web system are writable (during installation WEBO Site SpeedUp also creates backup of your files).</p><p class="wssI">WEBO Site SpeedUp can check all functions of your server and complete installation automatically. For this option please press <strong>"Express install"</strong>. On complete you can change any settings using this administative interface.</p><p class="wssI">If your want to set up usage of WEBO Site SpeedUp manually please press <strong>"Next"</strong>. You can check and set all settings before actual WEBO Site SpeedUp installation on your website.</p><p class="wssI"><a href="http://code.google.com/p/web-optimizator/wiki/StandaloneInstallation?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer" class="wssJ">WEBO Site SpeedUp installation process</a></p>');
