...
define('_WEBO_GENERAL_FOOTER', '快如闪电！');
...
/* lang menu */
define('_WEBO_GENERAL_LANGUAGE', '选择语言');
...
define('_WEBO_SPLASH2_CONTROLPANEL', '控制面板');
define('_WEBO_SPLASH2_OPTIONS', '选项');
define('_WEBO_SPLASH2_UNABLE', '无法打开');
define('_WEBO_SPLASH2_MAKESURE', '。请检查该目录是否存在。');

/* WEBO Site SpeedUp options */
define('_WEBO_general', '常规选项');
define('_WEBO_combinecss', '合并 CSS');
define('_WEBO_combine_js', '合并 JavaScript');
define('_WEBO_minify', '最小化');
define('_WEBO_gzip', 'Gzip 压缩');
define('_WEBO_clientside', '客户端缓存');
define('_WEBO_htaccess', '.htaccess');
define('_WEBO_backlink', '回链');
...
define('_WEBO_DASHBOARD_ACCOUNT', '个人数据');
define('_WEBO_DASHBOARD_CACHE', '缓存');
define('_WEBO_DASHBOARD_SYSTEM', '系统状态');
define('_WEBO_DASHBOARD_SPEED', '加载速度');
define('_WEBO_DASHBOARD_STATUS', '应用状态');
define('_WEBO_DASHBOARD_NEWS', '新闻');
define('_WEBO_DASHBOARD_BUZZ', 'Spread the Word!');
define('_WEBO_DASHBOARD_UPDATES', '更新');
define('_WEBO_DASHBOARD_RESULTS', '优化结果');
define('_WEBO_DASHBOARD_TOOLS', '优化工具');
define('_WEBO_DASHBOARD_LINKS', '快速链接');
define('_WEBO_DASHBOARD_AVAILABLE', 'Available in Premium Edition');
define('_WEBO_DASHBOARD_ALL', 'Available Blocks');
define('_WEBO_DASHBOARD_INSTALL', '安装');
define('_WEBO_DASHBOARD_SHARE_RESULTS', '在 Twitter 上分享结果');
...
define('_WEBO_DASHBOARD_CRITICAL_STEP1_5', '重新加载此页面');
...
define('_WEBO_DASHBOARD_CRITICAL_ISSUES', '已知问题');
...
define('_WEBO_DASHBOARD_STATUS_ENABLE', '启用');
define('_WEBO_DASHBOARD_STATUS_DISABLE', '禁用');
define('_WEBO_DASHBOARD_STATUS0','正在开始优化');
...
define('_WEBO_DASHBOARD_STATUS6','正在写入 .htaccess');
...
define('_WEBO_DASHBOARD_STATUS13','正在创建 JavaScript 缓存 &mdash; 正在压缩文件');
...
define('_WEBO_DASHBOARD_STATUS22','正在创建 CSS 缓存 &mdash; 正在压缩文件');
define('_WEBO_DASHBOARD_STATUS23','Checking HTML document');
define('_WEBO_DASHBOARD_STATUS24','正在压缩 HTML 文档');
define('_WEBO_DASHBOARD_STATUS_ALL','全部浏览器');
...
define('_WEBO_DASHBOARD_STATUS100','结束');
...
define('_WEBO_DASHBOARD_LINKS_ISSUES', '已知问题');
define('_WEBO_DASHBOARD_LINKS_SUPPORT', '技术支持');

/* Dashboard cache block */
define('_WEBO_DASHBOARD_CACHE_TITLE', '缓存状态');
...
define('_WEBO_DASHBOARD_CACHE_IMAGES', '图像');
define('_WEBO_DASHBOARD_CACHE_RESOURCES', 'data:URI + mhtml');
define('_WEBO_DASHBOARD_CACHE_SCRIPTS', 'PHP 脚本');
...
define('_WEBO_SYSTEM_mod_gzip', '无 <code>mod_gzip</code> 支持');
...
define('_WEBO_SYSTEM_mod_headers', '无 <code>mod_headers</code> 支持');
...
define('_WEBO_SYSTEM_mod_expires', '无 <code>mod_expires</code> 支持');
...
define('_WEBO_SYSTEM_mod_mime', '无 <code>mod_mime</code> 支持');
...
define('_WEBO_SYSTEM_mod_setenvif', '无 <code>mod_setenvif</code> 支持');
...
define('_WEBO_SYSTEM_mod_rewrite', '无 <code>mod_rewrite</code> 支持');
...
define('_WEBO_SYSTEM_mod_symlinks', '无 <code>SymLinks</code> 支持');
...
define('_WEBO_SYSTEM_protected_mode', '不是保护模式');
...
define('_WEBO_SYSTEM_cms', '无 CMS 支持');
...
/* System status */
define('_WEBO_SYSTEM_STATUS', '状态');
define('_WEBO_SYSTEM_SETTINGS', '设定');
define('_WEBO_SYSTEM_UPDATES', '更新');
define('_WEBO_SYSTEM_NOUPDATES', 'You are using the latest version of WEBO Site SpeedUp');
define('_WEBO_SYSTEM_ROLLBACK', '回滚到旧版本');
define('_WEBO_SYSTEM_INSTALL', '安装及卸载');
define('_WEBO_SYSTEM_STATUS_TITLE', '应用状态');
define('_WEBO_SYSTEM_ISSUES', '服务器状态');
define('_WEBO_SYSTEM_SETTINGS_TITLE', '应用设定');
define('_WEBO_SYSTEM_UPDATES_TITLE', '可用更新');
define('_WEBO_SYSTEM_INSTALL_TITLE', '安装及卸载');
...
define('_WEBO_DASHBOARD_SPEED_NODATA', '没有数据');

/* Dashboard awards block */
define('_WEBO_DASHBOARD_AWARDS_TITLE', '收获');
...
define('_WEBO_DASHBOARD_AWARDS_SPEEDUP', '提速');
...
define('_WEBO_SPLASH2_COMPARISON_DEMO', '社区');
...
/* Help screen */
define('_WEBO_HELP_WELCOME', '欢迎使用 WEBO Site SpeedUp');
define('_WEBO_HELP_MINIMIZE', '最小化');
define('_WEBO_HELP_CLOSE', '关闭');
define('_WEBO_HELP_FIRSTTIME', '第一次使用吗？');
...
define('_WEBO_HELP_LINK3', '已知问题');
define('_WEBO_HELP_LINK4', '技术支持');
define('_WEBO_HELP_LINK5', '在线商店');
define('_WEBO_HELP_MEDIA', '视频教程');
define('_WEBO_HELP_FEATURES', '新功能');
...
define('_WEBO_HELP_FEATURES_ALL', '全部功能');
define('_WEBO_HELP_FEATURES_BLOG', '官方博客');
define('_WEBO_HELP_HELP', '快速帮助');
...
define('_WEBO_WIZARD_STEP122', 'CSS gzip 压缩');
define('_WEBO_WIZARD_STEP13', 'JavaScript 优化');
...
define('_WEBO_WIZARD_STEP132', 'JavaScript gzip 压缩');
define('_WEBO_WIZARD_STEP14', 'HTML 优化');
define('_WEBO_WIZARD_STEP14_INFO', 'HTML code is being minified and gzipped, also HTML comments are being striped out.');
define('_WEBO_WIZARD_STEP142', 'HTML gzip 压缩');
...
define('_WEBO_WIZARD_STEP16', 'CDN 设置');
