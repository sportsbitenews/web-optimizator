...
define('_WEBO_GENERAL_BUYNOW', '<a href="https://www.softkey.net/catalog/basket.php?id=350446&amp;act=buy&amp;from=1722979" class="wssJ" title="WEBO Site SpeedUp Extended Edition">Comprar</a>');
define('_WEBO_GENERAL_BUYNOWLITE', '<a href="https://www.softkey.net/catalog/basket.php?id=350449&amp;act=buy&amp;from=1722979" class="wssJ" title="WEBO Site SpeedUp Standard Edition">Comprar</a>');
define('_WEBO_GENERAL_BUYNOWZERO', '<a href="https://www.softkey.net/catalog/basket.php?id=582711&amp;act=buy&amp;from=1722979" class="wssJ" title="WEBO Site SpeedUp Zero Edition">Comprar</a>');
...
define('_WEBO_unobtrusive_background', 'Cargar background imágenes en evento <code>DOMready</code>');
define('_WEBO_unobtrusive_background_HELP', 'Carga de imágenes de fondo serán retrasadas a evento DOMReady. Esto aumentará la velocidad de carga de la página web en navegadores.');
define('_WEBO_unobtrusive_background_EFFECT', 'Website rendering speedup by 20-50%');
define('_WEBO_unobtrusive_background_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformize los archivos del cache para todos los navegadores&quot; enabled.');
...
define('_WEBO_data_uris_mhtml_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformize los archivos del cache para todos los navegadores&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_separate_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformize los archivos del cache para todos los navegadores&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_size_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformize los archivos del cache para todos los navegadores&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_mhtml_size_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformize los archivos del cache para todos los navegadores&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_ignore_list_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformize los archivos del cache para todos los navegadores&quot; enabled or CSS files are not combined.');
...
define('_WEBO_data_uris_additional_list_HELP_DISABLED', 'It impossible to create cross browser data:URI because there is option &quot;Performance - Uniformize los archivos del cache para todos los navegadores&quot; enabled or CSS files are not combined.');
...
define('_WEBO_css_sprites_truecolor_in_jpeg_HELP_DISABLED', 'There is no complete GD library support on your website, so CSS Sprites creation is impossible. Or CSS Tidy library isn\'t selected to minify CSS.');
...
define('_WEBO_css_sprites_aggressive_HELP_DISABLED', 'There is no complete GD library support on your website, so CSS Sprites creation is impossible. Or CSS Tidy library isn\'t selected to minify CSS.');
...
define('_WEBO_css_sprites_extra_space_HELP_DISABLED', 'There is no complete GD library support on your website, so CSS Sprites creation is impossible. Or CSS Tidy library isn\'t selected to minify CSS.');
...
define('_WEBO_css_sprites_no_ie6_HELP_DISABLED', 'There is no complete GD library support on your website, so CSS Sprites creation is impossible. Or CSS Tidy library isn\'t selected to minify CSS.');
...
define('_WEBO_css_sprites_memory_limited_HELP_DISABLED', 'There is no complete GD library support on your website, so CSS Sprites creation is impossible. Or CSS Tidy library isn\'t selected to minify CSS.');
...
define('_WEBO_css_sprites_dimensions_limited_HELP_DISABLED', 'There is no complete GD library support on your website, so CSS Sprites creation is impossible. Or CSS Tidy library isn\'t selected to minify CSS.');
...
define('_WEBO_htaccess_mod_deflate_HELP', 'Esto es utilizado para compresión dinámica gzip. Es algo alternativo a gzip.');
...
define('_WEBO_htaccess_mod_gzip_HELP', 'Esto es necesitado para compresión dinámica  gzip. Es algo alternativo a deflate.');
...
define('_WEBO_iis_enabled', 'Activar <code>web.config</code>');
define('_WEBO_iis_local', 'Colocar el archivo <code>web.config</code> localmente (no en documento ra&iacute;z');
define('_WEBO_iis_mod_deflate', 'Usar <code>DEFLATE</code>');
define('_WEBO_iis_mod_gzip', 'Usar <code>httpCompression</code>');
define('_WEBO_iis_mod_expires', 'Usar <code>clientCache</code>');
define('_WEBO_iis_mod_headers', 'Usar <code>HEADERS</code>');
define('_WEBO_iis_mod_setenvif', 'Usar <code>SETENVIF</code>');
define('_WEBO_iis_mod_mime', 'Usar <code>MIME</code>');
define('_WEBO_iis_mod_rewrite', 'Usar <code>rewrite</code>');
...
define('_WEBO_DASHBOARD_AVAILABLE', 'Disponible solo en Extended Edition');
...
define('_WEBO_AWARDS_MIDDLE_INFO', 'Lighter website loads faster for all users, regardless their Internet connection. Website decrease in size is calculated with <a href="http://webopulsar.ru/">WEBO Pulsar</a> service.');
...
define('_WEBO_AWARDS_BOTTOM_INFO', 'Website load speed is one of the most important factors holding website visitors. Website speedup os calculated with <a href="http://webopulsar.ru/">WEBO Pulsar</a> service.');
