...
define('_WEBO_WIZARD_STEP12_INFO', 'All website CSS files are neing combined, minified, and gzipped to speed the website load up in every browser.');
define('_WEBO_WIZARD_STEP122', 'CSS gzip');
define('_WEBO_WIZARD_STEP13', 'JavaScript Optimiation');
define('_WEBO_WIZARD_STEP13_INFO', 'All JavaScript files are being combined, minified, and gzipped to decrease current website load time.');
define('_WEBO_WIZARD_STEP132', 'JavaScript gzip');
define('_WEBO_WIZARD_STEP14', 'HTML Optimization');
define('_WEBO_WIZARD_STEP14_INFO', 'HTML code is being minified and gzipped, also HTML comments are striped out.');
define('_WEBO_WIZARD_STEP142', 'HTML gzip');
define('_WEBO_WIZARD_STEP15', 'data:URI');
define('_WEBO_WIZARD_STEP15_INFO', 'Your website is being checked for data:URI and mhtml technologies support to reduce number of CSS images.');
define('_WEBO_WIZARD_STEP16', 'CDN Configuration');
define('_WEBO_WIZARD_STEP16_INFO', 'Current static files\' distribution settings are being calculated and CDN is being tuned.');
define('_WEBO_WIZARD_STEP17', 'CSS Sprites');
define('_WEBO_WIZARD_STEP17_INFO', 'Your website is being checked for CSS Sprites technology support to reduce number of HTML images.');
define('_WEBO_WIZARD_STEP18', 'Unobtrusive JavaScript');
define('_WEBO_WIZARD_STEP18_INFO', 'Your website is being checked for delayed loading techniques and unobtrusive JavaScript possibility.');
define('_WEBO_WIZARD_STEP21', 'Automatic tuning completed');
define('_WEBO_WIZARD_STEP21_INFO', 'Now you can finish with configuration tuning or learn more about WEBO Site SpeedUp options which can be tuned manually. You can always return to manual tuning on the page "Options".');
define('_WEBO_WIZARD_STEP211', 'Finish tuning');
define('_WEBO_WIZARD_STEP211_HELP', 'You can save final configuration with the end of WEBO Site SpeedUp tuning..');
define('_WEBO_WIZARD_STEP212', 'Continue with manual tuning');
define('_WEBO_WIZARD_STEP212_HELP', 'All WEBO Site SpeedUp options will be saved with manual tuning, also you will be able to learn more about options to perform their manual tuning.');
define('_WEBO_WIZARD_STEP22', 'Server Side Caching');
define('_WEBO_WIZARD_STEP22_INFO', 'Server side caching allows you to decrease delay before HTML pages are sent to website visitors, but some dynamic content can become unavailable with this method.');
define('_WEBO_WIZARD_STEP221', 'Don\'t apply server side caching');
define('_WEBO_WIZARD_STEP221_HELP', 'There is dynamic content on the website (such as e-commerce cart or personal account). Different visitors see website pages differently.');
define('_WEBO_WIZARD_STEP222', 'Apply server side caching�');
define('_WEBO_WIZARD_STEP222_HELP', 'There are no dynamic blocks on the website (such as e-commerce cart or personal account). All pages look idetical for every website visitor.');
define('_WEBO_WIZARD_STEP23', 'Gain even more speedup');
define('_WEBO_WIZARD_STEP23_INFO', 'All the other WEBO Site SpeedUp options can be tuned on page Options when Configuration Wizard has been completed.');
...
define('_WEBO_WIZARD_STEP31_INFO4', 'Our engineers will perform paid manual configuration and help to get maximum acceleration from your website.');
...
define('_WEBO_WIZARD_SAVE', 'Enable SpeedUp');
?>