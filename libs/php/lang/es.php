...
define('_WEBO_SYSTEM_wordpress_cache_enabled', 'Cache is not enabled in your WordPress');
define('_WEBO_SYSTEM_wordpress_cache_enabled_HELP', 'To use server side caching you need to add define (\'WP_CACHE\', true); to the wp-config.php file after the string with define(\'WPLANG\', ...) or make this file writable and then disable and re-enable Webo SiteSpeedup.');
