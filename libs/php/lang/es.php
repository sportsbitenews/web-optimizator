...
define('_WEBO_GENERAL_BUYNOW', '<a href="http://www.web-optimizer.us/?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer">Comprar edici&oacute;n Premium</a>');
...
define('_WEBO_GENERAL_DEMOVERSION', 'Edici&oacute;n comminuty');
...
define('_WEBO_NEW_PROTECT', '<p>Por favor ingrese un Login y Contrase&ntilde;a para proteger esta instalaci&oacute;n.</p><p>Antes de la instalaci&oacute;n, por favor revise que la ra&iacute;z <code>.htaccess</code> y archivos fuente del sistema de su web no est&eacute;n protegidos contra escritura (durante la instalaci&oacute;n Web Optimizer crea aparte, copia de seguridad de sus archivos iniciales).</p><p>Web Optimizer puede revisar todas las funciones de su servidor y completar la instalaci&oacute;n automaticamente. Para acceder a esta opci&oacute;n, por favor presione <strong>"Instalaci&oacute;n Express"</strong>. Una vez completado, usted puede cambiar cualquier opci&oacute;n usando esta m&oacute;dulo administrativo.</p><p>Si desea definir el uso de  Web Optimizer manualmente, por favor presione <strong>"Siguiente"</strong>. Usted puede revisar y definir todas las funciones antes de la la instalaci&oacute;n misma de Web Optimizer en su website.</p><p><a href="http://code.google.com/p/web-optimizator/wiki/StandaloneInstallation?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer">Proceso de instalaci&oacute;n de Web Optimizer</a></p>');
...
define('_WEBO_NEW_ORDERINSTALLATION', 'Compra de instalacion y la configuracion del Web Optimizer de su sitio web');
...
define('_WEBO_SPLASH1_UNINSTALL_THANKS', 'Gracias por usar <a href="http://www.web-optimizer.us/?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer">Web Optimizer</a>. Usted puede instalarlo nuevamente despu&eacute;s aqu&iacute; <a href="http://');
define('_WEBO_SPLASH1_UNINSTALL_THANKS2', '">P&aacute;gina de Web Optimizer</a>.');
define('_WEBO_SPLASH1_UNINSTALL_VISIT', 'Siempre puede visitar <a href="http://www.web-optimizer.us/?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer">el website de Web Optimizer</a> y compartir <a href="http://code.google.com/p/web-optimizator/issues/list?utm_source=product&amp;utm_medium=internal&amp;utm_campaign=web.optimizer">alg&uacute;n problema encontrado</a>.');
...
/* Change password */
define('_WEBO_PASSWORD_TITLE', 'Cambio de contrasena');
define('_WEBO_PASSWORD_INSTALLED', 'Web Optimizer esta instalado en este website. Puede cambiar su contrasena para tener acceso a sus funciones: Cambio de opciones, limpieza del Cache, Modernizacion, desactivacion y borrado.');
...
define('_WEBO_SPLASH2_WEBSITEROOT', 'Website est&aacute; localizado en');
define('_WEBO_SPLASH2_DOCUMENTROOT', 'Host points to (document root)');
define('_WEBO_SPLASH2_HOST', 'Website host, i.e. site.es');
...
<p>Por favor tenga cuidado al usar las opciones "Quitar comentarios HTML" o "achicar HTML". Lo anterior puede llevar a quitar un numero de counters (Comentarios internos del codigo de JavaScript), luego - a carga adicional del servidor en cada vista de pagina.</p>');
define('_WEBO_SPLASH2_UNOBTRUSIVE', 'JavaScript "no prominente"');
define('_WEBO_SPLASH2_UNOBTRUSIVE_INFO', '<p>JavaScript no prominente ser&aacute; cargado luego de que todo el contenido haya aparecido en el browser.</p><p>Esto puede aumentar considerablemente la velocidad de carga de su website. Pero en algunos casos puede interferir con la l&oacute;gica del cliente. Por favor tome precauci&oacute;n con esta opci&oacute;n.</p><p>Tambi&eacute;n puede mover toda ejecuci&oacute;n del JavaScript antes de <code>&lt;/body&gt;</code> &mdash; esto aumentar&aacute; considerablemente la velocidad de carga de su website.</p><p><a href="http://www.onlinetools.org/articles/unobtrusivejavascript/">JavaScript no prominente</a>, <a href="http://yuiblog.com/blog/2008/07/22/non-blocking-scripts/">Non-blocking JavaScript Downloads</a>, <a href="http://dean.edwards.name/weblog/2005/09/busted/">El <code>window.onload</code> Problema - Resuelto!</a>, <a href="http://dean.edwards.name/weblog/2006/06/again/"><code>window.onload</code> (again)</a></p>');
define('_WEBO_SPLASH2_EXTERNAL', 'Scripts externos y de linea');
define('_WEBO_SPLASH2_EXTERNAL_INFO', '<p>Con esta opci&oacute;n todos los scripts (incluyendo los archivos externos y los de linea) se fusionar&aacute;n a uno solo y se a&ntilde;adir&aacute; luego del archivo CSS.</p><p>Esto puede ser de bastante uso en algunos casos cuando hay gran variedad de plugins y m&oacute;dulos en la secci&oacute;n head y esta l&oacute;gica no puede ser movida a carga no prominente.</p><p>Usted tambi&eacute;n puede definir una lista de archivos excluidos (por ej. ga.js jquery.min.js).</p><p><a href="http://thinkvitamin.com/features/webapps/serving-javascript-fast/">Sirviendo JavaScript r&aacute;pidamente</a></p>');
define('_WEBO_SPLASH2_MTIME', 'Verificar los archivos mtime');
define('_WEBO_SPLASH2_MTIME_INFO', '<p>Usualmente Web Optimizer revisa si los archivos han sido cambiados desde el &uacute;ltimo ingreso a la p&acute;gina. Y usa la informaci&oacute;n extraida para dar a los archivos existentes informaci&oacute;n para memoria Cache o generar un archivo nuevo.</p><p>No es bueno desde el punto de vista de la optimizaci&oacute;n del lado del servidor por eso usted puede desactivar esta opci&oacute;n.</p><p>Al activar esta opci&oacute;n usted debe de administrar la memoria Cache del Web Optimizer manualmente para limpiar folders del Cache de archivos antiguos almacenados cuando nuevos recursos est&eacute;n disponibles.</p>');
define('_WEBO_SPLASH2_GZIP', 'Opciones Gzip');
define('_WEBO_SPLASH2_GZIP_INFO', '<p>El Gzipping comprime el c&oacute;digo a trav&eacute;s de compresi&oacute;n Gzip. Esto es recomendado solo para websites de peque&ntilde;a escala, y est&aacute; apagado predeterminadamente.</p><p>Para websites m&aacute;s grandes, usted deber&iacute;a efectuar Gzip por medio del web server. Web Optimizer by default adds all rules directly to server configuration.</p><p><a href="http://paulbuchheit.blogspot.com/2009/04/make-your-site-faster-and-cheaper-to.html">Haga su website m&aacute;s r&aacute;pido y m&aacute;s barato de operar de un simple paso</a></p>');
define('_WEBO_SPLASH2_EXPIRES', 'Client Side Cache');
define('_WEBO_SPLASH2_EXPIRES_INFO', '<p>Esto, a&ntilde;ade un encabezado de expiraci&oacute;n a sus archivos de JavaScript y CSS lo que asegura que est&eacute;n almacenados en el Cache del browser del cliente.</p><p>Cuando usted cambia su JS o CSS, un nuevo nombre de archivo es generado y la &uacute;ltima versi&oacute;n es consecuentemente descargada y grabada en el Cache.</p><p><a href="http://developer.yahoo.com/performance/rules.html#expires">A&ntilde;ade una Expiraci&oacute;n o Encabezado de Cache-Control</a></p>');
define('_WEBO_SPLASH2_HTMLCACHE', 'Server Side Cache');
define('_WEBO_SPLASH2_HTMLCACHE_INFO', '<p>Esta opci&oacute;n permite al Web Optimizer a almacenar en la memoria Cache resultados HTML generados y prevenir mucho trabajo del lado del servidor para generar estos mismos.</p><p>Nota, con esta opci&oacute;n toda la l&oacute;gica dependiente del servidor se desactivar&aacute;. Todas las p&aacute;ginas ser&aacute;n completamente est&aacute;ticas. Por favor active esta opci&oacute;n solo si est&aacute; seguro.</p><p><a href="http://www.stevesouders.com/blog/2009/05/18/flushing-the-document-early/">Flushing the Document Early</a> y <a href="http://blog.port80software.com/2006/11/08/">On Streaming, Chunking, and Finding the End</a></p>');
...
define('_WEBO_SPLASH2_HTACCESS_INFO', '<p>La mayor&iacute;a de opciones gzip y cache puede ser escrita para la configuraci&oacute;n de su website (y evitar trabajo adicional). Esto se puede efectuar v&iacute;a archivo <code>.htaccess</code> (y usted puede luego cortar opciones de ah&iacute; y mover a <code>httpd.cond</code> si es requerido).</p><p><a href="http://httpd.apache.org/docs/2.0/mod/mod_deflate.html">mod_deflate</a>, <a href="http://httpd.apache.org/docs/2.2/mod/mod_filter.html">mod_filter</a>, <a href="http://httpd.apache.org/docs/1.3/mod/mod_mime.html">mod_mime</a>, <a href="http://httpd.apache.org/docs/2.0/mod/mod_headers.html">mod_headers</a>, <a href="http://httpd.apache.org/docs/2.0/mod/mod_expires.html">mod_expires</a>, <a href="http://httpd.apache.org/docs/1.3/mod/mod_setenvif.html">mod_setenvif</a>.</p><p>Opciones disponibles: ');
define('_WEBO_SPLASH2_FOOTER', 'Backlink and spot');
define('_WEBO_SPLASH2_FOOTER_INFO', '<p>Web Optimizer puede a&ntilde;adir un enlace en el footer de su blog enlazado de regreso al website de Web Optimizer. El enlace puede ser uno de texto, una peque&ntilde;a imagen o ambos.</p><p>Por favor ayude a impulsar el Web Optimizer activando estos.</p>');
...
define('_WEBO_minify_css_body', 'Combinar archivos CSS dentro de <code>&lt;body&gt;</code>');
...
define('_WEBO_auto_rewrite_chained', 'Activar chained optimization');
...
define('_WEBO_SPLASH3_ADDITIONAL_INFO_1', '<strong>Haga su website compatible con los estandares (HTML, JavaScript, and CSS).</strong> Inclusion de archivos externos no compatibles llevan a un mal comportamiento del Web Optimizer y a su desconfiguracion.');
...
define('_WEBO_SYSTEM_CHECK', 'Viendo la configuracion del servidor...');
define('_WEBO_SYSTEM_CHECK_ENABLED', 'Activado');
define('_WEBO_SYSTEM_CHECK_DISABLED', 'Desactivado');
define('_WEBO_SYSTEM_CHECK_WRITABLE', 'si');
define('_WEBO_SYSTEM_CHECK_RESTRICTED', 'no');
define('_WEBO_SYSTEM_CHECK_SYSTEM_INFO', 'Configuracion del servidor');
...
define('_WEBO_SYSTEM_CHECK_HTACCESS_SUPPORT', '<code>.htaccess</code> compatible');
define('_WEBO_SYSTEM_CHECK_HTACCESS', '<code>.htaccess</code> es grabable');
...
define('_WEBO_SYSTEM_CHECK_HTACCESS_PROTECTED', 'Modo protegido para instalacion');
define('_WEBO_SYSTEM_CHECK_CSS_DIRECTORY', 'Subdirectorio CSS es grabable');
define('_WEBO_SYSTEM_CHECK_JAVASCRIPT_DIRECTORY', 'Subdirectorio JavaScript es grabable');
define('_WEBO_SYSTEM_CHECK_HTML_DIRECTORY', 'subdirectorio HTML es grabable');
define('_WEBO_SYSTEM_CHECK_INDEX', '<code>/index.php</code> es grabable');
define('_WEBO_SYSTEM_CHECK_CONFIG', 'Archivo de configuracion es grabable');
define('_WEBO_SYSTEM_CHECK_GZIP', '<code>gzip</code> "al vuelo"');
define('_WEBO_SYSTEM_CHECK_GZIP_STATIC', 'Estatico <code>gzip</code>');
define('_WEBO_SYSTEM_CHECK_CACHE', 'Caching del lado del cliente');
define('_WEBO_SYSTEM_CHECK_CSS_SPRITES', 'CSS Sprites compatible');
define('_WEBO_SYSTEM_CHECK_CSS_MINIFY', 'Minificar para CSS');
define('_WEBO_SYSTEM_CHECK_JS_MINIFY', 'Minificar para JS');
